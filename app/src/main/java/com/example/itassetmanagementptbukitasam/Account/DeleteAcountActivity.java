...
public class DeleteAcountActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backDel = findViewById(R.id.back_delete_account_admin);
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(DeleteAcountActivity.this, "Something went wrong !" +
                    "User details are not available at the moment", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(DeleteAcountActivity.this, ProfileAdminActivity.class);
    ...
    private void reAutenticated(FirebaseUser firebaseUser) {
        Button verifyUser = findViewById(R.id.button_delete_admin_authenticate);
        verifyUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userPwd)){
                    Toast.makeText(DeleteAcountActivity.this, "Password is needed to continue", Toast.LENGTH_SHORT).show();
                    ...
                    firebaseUser.reauthenticate(authCredential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(DeleteAcountActivity.this, "Password has been verified" +
                                ...
                                buttonDeleteUser.setBackgroundTintList(ContextCompat.getColorStateList(DeleteAcountActivity.this,
                                        R.color.red));
                                ...
                                try {
                                    ...
                                    Toast.makeText(DeleteAcountActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
    ...
    private void showAlertDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DeleteAcountActivity.this);
        ...
        firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    deleteUserData();
                    auth.signOut();
                    Toast.makeText(DeleteAcountActivity.this, "User has been deleted!!",
                            Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(DeleteAcountActivity.this, SignInActivity.class);
                    startActivity(intent);
                    finish();
                }else {
                    try {
