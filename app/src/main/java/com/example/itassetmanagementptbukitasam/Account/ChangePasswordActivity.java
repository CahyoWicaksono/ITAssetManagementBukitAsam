...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backEdit = findViewById(R.id.back_password_admin);
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(ChangePasswordActivity.this, "Something went wrong!! User's details available", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ChangePasswordActivity.this, ProfileAdminActivity.class);
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(ChangePasswordActivity.this, "You are authenticated/verified." + "You can change password now!!", Toast.LENGTH_SHORT).show();
    ...
    private void chagePwd(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(userPwdNew)){
            ...
            Toast.makeText(ChangePasswordActivity.this, "New Password cannoe be same as old password", Toast.LENGTH_SHORT).show();
