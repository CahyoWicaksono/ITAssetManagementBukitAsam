...
public class AddRegisterOprational extends AppCompatActivity {
    ...
    private static final String TAG = "AddRegisterOprational";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register_oprational);

        Toast.makeText(AddRegisterOprational.this, "You can register now", Toast.LENGTH_SHORT).show();

        swipeToRefresh();
        editTextRegisterFullnameAdmin = findViewById(R.id.editText_register_full_name_oprational);
        editTextRegisterEmailAdmin = findViewById(R.id.editText_register_email_oprational);
        editTextRegisterDateAdmin = findViewById(R.id.editText_register_dob_oprational);
        editTextRegisterMobileAdmin = findViewById(R.id.editText_register_mobile_oprational);
        editTextRegisterPwdAdmin = findViewById(R.id.editText_register_password_oprational);
        editTextRegisterConPwdAdmin = findViewById(R.id.editText_register_conpassword_oprational);
        backRegisterAdmin = findViewById(R.id.backRegister_oprational);

        progressBarAdmin = findViewById(R.id.progressBar_oprational);
        radioGroupRegisterGenderAdmin = findViewById(R.id.radio_group_register_gender_oprational);
        radioGroupRegisterGenderAdmin.clearCheck();

        backRegisterAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddRegisterOprational.this, AccessActivity.class);
        ...
        editTextRegisterDateAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pickerDialogAdmin = new DatePickerDialog(AddRegisterOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Button register = findViewById(R.id.button_register_oprational);
...
//                mobileMatcer = mobilePattern.matcher(textMobile);
                ...
                if (TextUtils.isEmpty(textFullname)) {
                    Toast.makeText(AddRegisterOprational.this, "Please enter your fullname", Toast.LENGTH_SHORT).show();
                    editTextRegisterFullnameAdmin.setError("your fullname is required");
                    editTextRegisterFullnameAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textEmail)) {
                    Toast.makeText(AddRegisterOprational.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                    editTextRegisterEmailAdmin.setError("email is required");
                    editTextRegisterEmailAdmin.requestFocus();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(textEmail).matches()) {
                    Toast.makeText(AddRegisterOprational.this, "Please re-enter your email", Toast.LENGTH_SHORT).show();
                    editTextRegisterEmailAdmin.setError("Email is required");
                    editTextRegisterEmailAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textDate)) {
                    Toast.makeText(AddRegisterOprational.this, "Please enter your Date of Birth", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterOprational.this, "Please enter your gender", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterOprational.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
                    editTextRegisterMobileAdmin.setError("phone Number is required");
                    editTextRegisterMobileAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textPwd)) {
                    Toast.makeText(AddRegisterOprational.this, "Please enter your Password", Toast.LENGTH_SHORT).show();
                    editTextRegisterPwdAdmin.setError("Your Password is required");
                    editTextRegisterPwdAdmin.requestFocus();
                } else if (textPwd.length() < 6) {
                    Toast.makeText(AddRegisterOprational.this, "Pasword should be at least 6 digit", Toast.LENGTH_SHORT).show();
                    editTextRegisterPwdAdmin.setError("Your password too weak");
                    editTextRegisterPwdAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textConPwd)) {
                    Toast.makeText(AddRegisterOprational.this, "Please confirm your Password", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterOprational.this, "Please same password", Toast.LENGTH_SHORT).show();
                    editTextRegisterConPwdAdmin.setError("Confirm Password is required");
                    editTextRegisterConPwdAdmin.requestFocus();
                    ...
                    registerOprational(textFullname, textEmail, textDate, textPwd, textConPwd, textGender, textMobile);

                }
            }
        });
    }
    private void registerOprational(String textFullname, String textEmail, String textDate, String textPwd, String textConPwd, String textGender, String textMobile) {
        FirebaseAuth auth = FirebaseAuth.getInstance();

        auth.createUserWithEmailAndPassword(textEmail, textPwd).addOnCompleteListener(AddRegisterOprational.this, new OnCompleteListener<AuthResult>() {
            @Override
...
//                                showAlertDialog();
                                Toast.makeText(AddRegisterOprational.this, "Create Access is Succesfully", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(AddRegisterOprational.this, "Register Failed !!!,Please try again", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    try {
                        ...
                        Toast.makeText(AddRegisterOprational.this, e.getMessage(), Toast.LENGTH_SHORT).show();
