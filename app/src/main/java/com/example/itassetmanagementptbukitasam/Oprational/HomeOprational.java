...
import com.example.itassetmanagementptbukitasam.ListData.Receiver.ListReceiver.ReceiverOprationalActivity;
...
import com.example.itassetmanagementptbukitasam.ListData.Response.List.ResponseViewOprationalActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalOprationalActivity;
...
public class HomeOprational extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_oprational);

        swipeToRefresh();
        onBackPressed();

        menuComplain = findViewById(R.id.complaint_oprational);
        menuWith = findViewById(R.id.withdrawal_oprational);
        menuRequest = findViewById(R.id.request_oprational);
        menuReceiver = findViewById(R.id.receiver_oprational);
        menuResposnse = findViewById(R.id.response_oprational);

        database = findViewById(R.id.database_progress_oprational);
        qrprogress = findViewById(R.id.qr_progress_oprational);
        schedule = findViewById(R.id.schedule_progress_oprational);
        damageProgress = findViewById(R.id.damage_progress_oprational);
        information = findViewById(R.id.information_asset_oprational);

        location_admin = findViewById(R.id.location_oprational);
        slider_admin = findViewById(R.id.Slidder_oprational);

        auth = FirebaseAuth.getInstance();

        setting=findViewById(R.id.setting_oprational);
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SettingOprationalActivity.class);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.menu_update_profile:
                        startActivity(new Intent(getApplicationContext(), UpdateProfileOprationalActivity.class));
                    ...
                    case R.id.menu_delete:
                        startActivity(new Intent(getApplicationContext(), DeleteAcountOprational.class));
                        overridePendingTransition(0, 0);
                        return true;
                    case R.id.menu_logout:
                        Toast.makeText(HomeOprational.this, "User Logged Out...", Toast.LENGTH_SHORT).show();
                        auth.signOut();
                        Intent intent = new Intent(HomeOprational.this, SignInOprationalActivity.class);
                        startActivity(intent);
                        return true;
                }
                return false;
        ...
        bottomNavigationView = findViewById(R.id.botomNavigationView_oprational);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(HomeOprational.this);
        ...
        information.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(HomeOprational.this)
                        .setTitle("Features")
        ...
        menuComplain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddComplaintOprational.class);
                startActivity(intent);
                finish();
            }
        });
        menuWith.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ViewWithdrawalOprationalActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuResposnse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ResponseViewOprationalActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RequestOprationalActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuReceiver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ReceiverOprationalActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(HomeOprational.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
