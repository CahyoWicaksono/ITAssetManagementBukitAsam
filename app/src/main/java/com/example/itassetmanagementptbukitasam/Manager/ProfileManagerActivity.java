...
public class ProfileManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        swipeToRefresh();
        textViewFullName    = findViewById(R.id.textView_show_full_name_Manager);
        textViewEmail       = findViewById(R.id.textView_show_email_Manager);
        textViewDob         = findViewById(R.id.textView_show_dob_Manager);
        textViewMobile      = findViewById(R.id.textView_show_mobile_Manager);
        textViewGender      = findViewById(R.id.textView_show_gender_Manager);
        progressBar         = findViewById(R.id.progress_bar_Manager);


        bottomNavigationViewProfile = findViewById(R.id.botomNavigationView_profile_Manager);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ProfileManagerActivity.this);
        ...
        if (firebaseUser == null){
            Toast.makeText(ProfileManagerActivity.this, "Something went wrong! User's details are not available at the moment",
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        databaseReference.child(UserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProfileManagerActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
