...
public class UpdateProfileAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        date_picker = findViewById(R.id.imageView_date_picker);

        backup = findViewById(R.id.backprofile);
        ...
        backup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(UpdateProfileAdminActivity.this, ProfileAdminActivity.class);
        ...
        date_picker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pickerDialog = new DatePickerDialog(UpdateProfileAdminActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void updateProfileAdmin(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(textFullname)) {
            Toast.makeText(UpdateProfileAdminActivity.this, "Please enter your fullname", Toast.LENGTH_SHORT).show();
            editTextUpdateName.setError("your fullname is required");
            editTextUpdateName.requestFocus();
        }else if (TextUtils.isEmpty(textDob)) {
            Toast.makeText(UpdateProfileAdminActivity.this, "Please enter your Date of Birth", Toast.LENGTH_SHORT).show();
            editTextUpdateDob.setError("Date of Birth is required");
            editTextUpdateDob.requestFocus();
        }else if (TextUtils.isEmpty(radioButtonUpdateSelect.getText())) {
            Toast.makeText(UpdateProfileAdminActivity.this, "Please enter your gender", Toast.LENGTH_SHORT).show();
            radioButtonUpdateSelect.setError("Gender is required");
            radioButtonUpdateSelect.requestFocus();
        }else if (TextUtils.isEmpty(textMobile)) {
            Toast.makeText(UpdateProfileAdminActivity.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
            ...
            databaseReference.child(adminId).setValue(writeAccountDetailsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(UpdateProfileAdminActivity.this, "Update Successfull", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(UpdateProfileAdminActivity.this, ProfileAdminActivity.class);
                        ...
                        try {
                            ...
                            Toast.makeText(UpdateProfileAdminActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        databaseReference.child(userIdOfRegistered).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (writeAccountDetailsModel != null) {
                    ...
                    Toast.makeText(UpdateProfileAdminActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
                progressBar.setVisibility(View.GONE);
            }
