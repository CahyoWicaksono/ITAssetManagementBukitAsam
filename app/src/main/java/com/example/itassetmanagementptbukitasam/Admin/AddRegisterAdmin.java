...
public class AddRegisterAdmin extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toast.makeText(AddRegisterAdmin.this, "You can register now", Toast.LENGTH_SHORT).show();
        ...
        editTextRegisterDateAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pickerDialogAdmin = new DatePickerDialog(AddRegisterAdmin.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                mobileMatcer = mobilePattern.matcher(textMobile);
                ...
                if (TextUtils.isEmpty(textFullname)) {
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your fullname", Toast.LENGTH_SHORT).show();
                    editTextRegisterFullnameAdmin.setError("your fullname is required");
                    editTextRegisterFullnameAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textEmail)) {
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                    editTextRegisterEmailAdmin.setError("email is required");
                    editTextRegisterEmailAdmin.requestFocus();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(textEmail).matches()) {
                    Toast.makeText(AddRegisterAdmin.this, "Please re-enter your email", Toast.LENGTH_SHORT).show();
                    editTextRegisterEmailAdmin.setError("Email is required");
                    editTextRegisterEmailAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textDate)) {
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your Date of Birth", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your gender", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
                    editTextRegisterMobileAdmin.setError("phone Number is required");
                    editTextRegisterMobileAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textPwd)) {
                    Toast.makeText(AddRegisterAdmin.this, "Please enter your Password", Toast.LENGTH_SHORT).show();
                    editTextRegisterPwdAdmin.setError("Your Password is required");
                    editTextRegisterPwdAdmin.requestFocus();
                } else if (textPwd.length() < 6) {
                    Toast.makeText(AddRegisterAdmin.this, "Pasword should be at least 6 digit", Toast.LENGTH_SHORT).show();
                    editTextRegisterPwdAdmin.setError("Your password too weak");
                    editTextRegisterPwdAdmin.requestFocus();
                } else if (TextUtils.isEmpty(textConPwd)) {
                    Toast.makeText(AddRegisterAdmin.this, "Please confirm your Password", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddRegisterAdmin.this, "Please same password", Toast.LENGTH_SHORT).show();
                    editTextRegisterConPwdAdmin.setError("Confirm Password is required");
                    editTextRegisterConPwdAdmin.requestFocus();
    ...
    private void registerAdmin(String textFullname, String textEmail, String textDate, String textPwd, String textConPwd, String textGender, String textMobile) {
        ...
        auth.createUserWithEmailAndPassword(textEmail, textPwd).addOnCompleteListener(AddRegisterAdmin.this, new OnCompleteListener<AuthResult>() {
            @Override
...
//                                showAlertDialog();
                                Toast.makeText(AddRegisterAdmin.this, "Create Access is Succesfully", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(AddRegisterAdmin.this, "Register Failed !!!,Please try again", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    try {
                        ...
                        Toast.makeText(AddRegisterAdmin.this, e.getMessage(), Toast.LENGTH_SHORT).show();
