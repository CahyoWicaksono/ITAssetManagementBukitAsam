...
public class AddComplaintHumas extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String ComplaintID;
    private static final String TAG = "AddComplaintHumas";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_complain_humas);


        namaPengadu = findViewById(R.id.et_name_complaint_humas);
        tanggalPengadu = findViewById(R.id.et_date_complaint_humas);
        Divisi = findViewById(R.id.et_division_complaint_humas);
        NamaAset = findViewById(R.id.et_name_asset_complaint_humas);
        Problem = findViewById(R.id.et_problem_complaint_humas);


        backmaintenance = findViewById(R.id.back_complaint_humas);

        btn_simpan = findViewById(R.id.btn_submit_humas);
        ...
        tanggalPengadu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddComplaintHumas.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddComplaintHumas.this, HomeHumas.class));
