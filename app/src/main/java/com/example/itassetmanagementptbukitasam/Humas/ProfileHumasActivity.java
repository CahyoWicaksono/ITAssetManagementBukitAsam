...
public class ProfileHumasActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humas_profile);


        swipeToRefresh();

        textViewFullName    = findViewById(R.id.textView_show_full_name_humas);
        textViewEmail       = findViewById(R.id.textView_show_email_humas);
        textViewDob         = findViewById(R.id.textView_show_dob_humas);
        textViewMobile      = findViewById(R.id.textView_show_mobile_humas);
        textViewGender      = findViewById(R.id.textView_show_gender_humas);
        progressBar         = findViewById(R.id.progress_bar_humas);


        bottomNavigationViewProfile = findViewById(R.id.botomNavigationView_profile_humas);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ProfileHumasActivity.this);
        ...
        if (firebaseUser == null){
            Toast.makeText(ProfileHumasActivity.this, "Something went wrong! User's details are not available at the moment",
                    Toast.LENGTH_SHORT).show();
        }else {
            checkIfEmailVerified(firebaseUser);
            progressBar.setVisibility(View.VISIBLE);
            showHumasProfile(firebaseUser);
        }
    ...
    private void showHumasProfile(FirebaseUser firebaseUser) {
        ...
        databaseReference.child(UserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProfileHumasActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(ProfileHumasActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
