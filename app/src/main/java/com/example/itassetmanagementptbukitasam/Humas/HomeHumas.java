...
public class HomeHumas extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_humas);

        menuComplain = findViewById(R.id.complaint_humas);
        menuWith = findViewById(R.id.withdrawal_humas);
        menuRequest = findViewById(R.id.request_humas);
        menuReceiver = findViewById(R.id.receiver_humas);
        menuResposnse = findViewById(R.id.response_humas);

        database = findViewById(R.id.database_progress_humas);
        qrprogress = findViewById(R.id.qr_progress_humas);
        schedule = findViewById(R.id.schedule_progress_humas);
        damageProgress = findViewById(R.id.damage_progress_humas);
        information = findViewById(R.id.information_asset_humas);

        location_admin = findViewById(R.id.location_humas);
        slider_admin = findViewById(R.id.Slidder_humas);

        auth = FirebaseAuth.getInstance();

        bottomNavigationView = findViewById(R.id.botomNavigationView_humas);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(HomeHumas.this);
        ...
        information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(HomeHumas.this)
                        .setTitle("Features")
        ...
        setting=findViewById(R.id.setting_humas);
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SettingHumasActivity.class);
        ...
        menuComplain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddComplaintHumas.class);
                startActivity(intent);
                finish();
            }
        });
        menuWith.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ViewWithdrawalHumasActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuResposnse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ResponseViewHumasActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RequestHumasActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuReceiver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ReceiverHumasActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(HomeHumas.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
