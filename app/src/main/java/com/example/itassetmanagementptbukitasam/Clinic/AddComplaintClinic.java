...
public class AddComplaintClinic extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String ComplaintID;
    private static final String TAG = "AddComplaintClinic";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        namaPengadu = findViewById(R.id.et_name_complaint);
        tanggalPengadu = findViewById(R.id.et_date_complaint);
        Divisi = findViewById(R.id.et_division_complaint);
        NamaAset = findViewById(R.id.et_name_asset_complaint);
        Problem = findViewById(R.id.et_problem_complaint);


        backmaintenance = findViewById(R.id.back_complaint);
        ...
        backmaintenance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), HomeClinic.class);
        ...
        tanggalPengadu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddComplaintClinic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddComplaintClinic.this, HomeClinic.class));
