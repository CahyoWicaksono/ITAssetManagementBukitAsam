...
public class AddComplaintLogistic extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String ComplaintID;
    private static final String TAG = "AddComplaintLogistic";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_complain_logistic);


        namaPengadu = findViewById(R.id.et_name_complaint_logistic);
        tanggalPengadu = findViewById(R.id.et_date_complaint_logistic);
        Divisi = findViewById(R.id.et_division_complaint_logistic);
        NamaAset = findViewById(R.id.et_name_asset_complaint_logistic);
        Problem = findViewById(R.id.et_problem_complaint_logistic);


        backmaintenance = findViewById(R.id.back_complaint_logistic);

        btn_simpan = findViewById(R.id.btn_submit_logistic);
        ...
        tanggalPengadu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddComplaintLogistic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddComplaintLogistic.this, HomeLogisticActivity.class));
