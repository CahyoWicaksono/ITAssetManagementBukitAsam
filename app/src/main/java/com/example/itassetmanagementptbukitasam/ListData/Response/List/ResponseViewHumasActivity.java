...
public class ResponseViewHumasActivity extends AppCompatActivity implements ResponseHumasAdapter.ResponseHumasClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_view_response_humas);

        recyclerView            = findViewById(R.id.am_response_humas_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Response_Humas");
        responseModelArrayList = new ArrayList<>();
        bottomresponse            = findViewById(R.id.idRLResponseHumas_view);
        loadingPB               = findViewById(R.id.progress_bar_response_humas_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_response_humas_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ResponseViewHumasActivity.this);
    ...
    private  void displayBottomShet(ResponseModel responseModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_view_response_humas,bottomresponse);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name             = layout.findViewById(R.id.idTVNameResponseHumas_view);
        TextView Date             = layout.findViewById(R.id.idTVDateResponseHumas_view);
        TextView Division         = layout.findViewById(R.id.idTVDivisionResponseHumas_view);
        TextView AssetName        = layout.findViewById(R.id.idTVAssetNameResponseHumas_view);
        TextView Status           = layout.findViewById(R.id.idTVStatusResponseHumas_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    ResponseViewHumasActivity.this);
            ...
            Toast.makeText(ResponseViewHumasActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
