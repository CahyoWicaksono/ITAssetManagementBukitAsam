...
public class ViewSafetyRequestActivity extends AppCompatActivity implements RequestAdapter.ViewDataRequestClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_permintaan_view_safety);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.permintaan_data_view_safety);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Request_safety");
        requestModelArrayList = new ArrayList<>();
        bottomRequest            = findViewById(R.id.idRLAset_request_view_safety);
        loadingPB               = findViewById(R.id.progress_bar_request_view_safety);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_request_view_safety);
    ...
    private  void displayBottomShet(RequestModel requestModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_permintaan_view_safety,bottomRequest);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Request             = layout.findViewById(R.id.idTVAssetName_request_view_safety);
        TextView Asset_Code_Request             = layout.findViewById(R.id.idTVAssetName_request_view_safety);
        TextView Divisi_Asset_Request           = layout.findViewById(R.id.idTVType_request_view_safety);
        TextView Amount_Request                 = layout.findViewById(R.id.idTVAmount_request_view_safety);
        TextView Description_Request            = layout.findViewById(R.id.idTVDesc_request_view_safety);
        TextView Date_Request                   = layout.findViewById(R.id.idTVDate_request_view_safety);

        ImageView Image_Asset                   = layout.findViewById(R.id.image_asset_request_view_safety);
