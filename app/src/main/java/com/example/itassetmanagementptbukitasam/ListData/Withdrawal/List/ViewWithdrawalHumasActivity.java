...
public class ViewWithdrawalHumasActivity extends AppCompatActivity implements WithdrawalHumasAdapter.WithdrawalHumasClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_withdrawal_view_humas);


        swipeToRefresh();

        recyclerView = findViewById(R.id.with_data_humas_view);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Withdrawal_humas");
        withdrawalModelArrayList = new ArrayList<>();
        bottomWith = findViewById(R.id.idRLWithdrawal_humas_view);
        loadingPB = findViewById(R.id.progress_bar_withdrawal_humas_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_withrawal_humas_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ViewWithdrawalHumasActivity.this);
    ...
    private  void displayBottomShet(WithdrawalModel withdrawalModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_withdrawal_data_humas_view,bottomWith);
        ...
        TextView WithCode           = layout.findViewById(R.id.idTVWithdrawalCode_humas_view);
        TextView AssetCode      = layout.findViewById(R.id.idTVAssetCode_Withdrawal_humas_view);
        TextView Date      = layout.findViewById(R.id.idTVDateWithdrawal_humas_view);
        TextView Amount         = layout.findViewById(R.id.idTVAmountWithdrawal_humas_view);
        TextView Division           = layout.findViewById(R.id.idTVDivisonWithdrawal_humas_view);
        TextView Reason  = layout.findViewById(R.id.idTVReasonWithdrawal_humas_view);
        TextView Officer         = layout.findViewById(R.id.idTVOfficerWithdrawal_humas_view);
        TextView Description  = layout.findViewById(R.id.idTVDescriptionWithdrawal_humas_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    ViewWithdrawalHumasActivity.this);
            ...
            Toast.makeText(ViewWithdrawalHumasActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
