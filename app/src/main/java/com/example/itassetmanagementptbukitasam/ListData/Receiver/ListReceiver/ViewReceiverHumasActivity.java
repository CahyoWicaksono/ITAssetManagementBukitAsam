...
public class ViewReceiverHumasActivity extends AppCompatActivity implements ReceiverHumasAdapter.ViewDataHumasReceiverClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_penerimaan_humas_view);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.penerimaan_data_humas_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Receiver_humas");
        receiverModelArrayList   = new ArrayList<>();
        bottomreceiver            = findViewById(R.id.idRLAset_receiver_humas_view);
        loadingPB               = findViewById(R.id.progress_bar_receiver_humas_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_receiver_humas_view);
    ...
    private  void displayBottomShet(ReceiverModel receiverModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_penerimaan_humas_view,bottomreceiver);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_humas_view);
        TextView Asset_Code_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_humas_view);
        TextView Divisi_Asset_Receiver           = layout.findViewById(R.id.idTVType_receiver_humas_view);
        TextView Amount_Receiver                 = layout.findViewById(R.id.idTVAmount_receiver_humas_view);
        TextView Condition_Receiver            = layout.findViewById(R.id.idTVDesc_receiver_humas_view);
        TextView Date_Receiver                   = layout.findViewById(R.id.idTVDate_receiver_humas_view);
