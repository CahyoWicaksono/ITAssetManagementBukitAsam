...
public class WithdrawalSafetyActivity extends AppCompatActivity implements WithdrawalSafetyAdapter.WithdrawalSafetyClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_withdrawal_safety);


        swipeToRefresh();

        recyclerView = findViewById(R.id.with_data_safety);
        floatingActionButton = findViewById(R.id.tambah_penarikan_safety);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Withdrawal_safety");
        withdrawalModelArrayList = new ArrayList<>();
        bottomWith = findViewById(R.id.idRLWithdrawal_safety);
        loadingPB = findViewById(R.id.progress_bar_withdrawal_safety);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_withrawal_safety);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(WithdrawalSafetyActivity.this, AddWithdrawalSafetyActivity.class));
    ...
    private  void displayBottomShet(WithdrawalModel withdrawalModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_withdrawal_data_safety,bottomWith);
        ...
        TextView WithCode           = layout.findViewById(R.id.idTVWithdrawalCode_safety);
        TextView AssetCode      = layout.findViewById(R.id.idTVAssetCode_Withdrawal_safety);
        TextView Date      = layout.findViewById(R.id.idTVDateWithdrawal_safety);
        TextView Amount         = layout.findViewById(R.id.idTVAmountWithdrawal_safety);
        TextView Division           = layout.findViewById(R.id.idTVDivisonWithdrawal_safety);
        TextView Reason  = layout.findViewById(R.id.idTVReasonWithdrawal_safety);
        TextView Officer         = layout.findViewById(R.id.idTVOfficerWithdrawal_safety);
        TextView Description  = layout.findViewById(R.id.idTVDescriptionWithdrawal_safety);

        Button editData = layout.findViewById(R.id.editDataWithdrawal_safety);
        Button deleteData = layout.findViewById(R.id.DeleteDataWithdrawal_safety);
        ...
        editData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(WithdrawalSafetyActivity.this, EditWithdrawalSafety.class);
                i.putExtra("withdrawal_safety", withdrawalModel);
                startActivity(i);
            }
        });
        ...
        deleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(WithdrawalSafetyActivity.this, "Withdrawal deleted...", Toast.LENGTH_SHORT).show();
