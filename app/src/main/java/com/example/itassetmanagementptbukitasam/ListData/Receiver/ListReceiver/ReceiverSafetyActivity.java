...
public class ReceiverSafetyActivity extends AppCompatActivity implements ReceiverSafetyAdapter.ViewDataSafetyReceiverClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_penerimaan_safety);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.penerimaan_data_safety);
        floatingActionButton    = findViewById(R.id.tambah_receiver_safety);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Receiver_safety");
        receiverModelArrayList   = new ArrayList<>();
        bottomreceiver            = findViewById(R.id.idRLAset_receiver_safety);
        loadingPB               = findViewById(R.id.progress_bar_receiver_safety);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_receiver_safety);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ReceiverSafetyActivity.this);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ReceiverSafetyActivity.this, AddReceiverSafety.class));
    ...
    private  void displayBottomShet(ReceiverModel receiverModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_penerimaan_safety,bottomreceiver);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_safety);
        TextView Asset_Code_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_safety);
        TextView Divisi_Asset_Receiver           = layout.findViewById(R.id.idTVType_receiver_safety);
        TextView Amount_Receiver                 = layout.findViewById(R.id.idTVAmount_receiver_safety);
        TextView Condition_Receiver            = layout.findViewById(R.id.idTVDesc_receiver_safety);
        TextView Date_Receiver                   = layout.findViewById(R.id.idTVDate_receiver_safety);

        Button editData                         = layout.findViewById(R.id.editData_receiver_safety);
        Button deleteData                       = layout.findViewById(R.id.DeleteData_receiver_safety);
        ...
        editData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ReceiverSafetyActivity.this, EditAssetSafety.class);
                i.putExtra("receiver_safety", receiverModel);
                startActivity(i);
            }
        });
        ...
        deleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ReceiverSafetyActivity.this, "Data deleted...", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), ReceiverSafetyActivity.class));
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(ReceiverSafetyActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
