...
public class ViewOprationalRequestActivity extends AppCompatActivity implements RequestAdapter.ViewDataRequestClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_permintaan_view_oprational);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.permintaan_data_view_oprational);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Request_oprational");
        requestModelArrayList = new ArrayList<>();
        bottomRequest            = findViewById(R.id.idRLAset_request_oprational_view);
        loadingPB               = findViewById(R.id.progress_bar_request_view_oprational);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_request_view_oprational);
    ...
    private  void displayBottomShet(RequestModel requestModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_permintaan_view_oprational,bottomRequest);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Request             = layout.findViewById(R.id.idTVAssetName_request_oprational_view);
        TextView Asset_Code_Request             = layout.findViewById(R.id.idTVAssetName_request_oprational_view);
        TextView Divisi_Asset_Request           = layout.findViewById(R.id.idTVType_request_oprational_view);
        TextView Amount_Request                 = layout.findViewById(R.id.idTVAmount_request_oprational_view);
        TextView Description_Request            = layout.findViewById(R.id.idTVDesc_request_oprational_view);
        TextView Date_Request                   = layout.findViewById(R.id.idTVDate_request_oprational_view);

        ImageView Image_Asset                   = layout.findViewById(R.id.image_asset_request_oprational_view);
