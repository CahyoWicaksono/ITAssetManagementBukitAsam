...
public class ViewReceiverOprationalActivity extends AppCompatActivity implements ReceiverOprationalAdapter.ViewDataOprationalReceiverClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_penerimaan_oprational_view);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.penerimaan_data_oprational_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Receiver_oprational");
        receiverModelArrayList   = new ArrayList<>();
        bottomreceiver            = findViewById(R.id.idRLAset_receiver_oprational_view);
        loadingPB               = findViewById(R.id.progress_bar_receiver_oprational_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_receiver_oprational_view);
    ...
    private  void displayBottomShet(ReceiverModel receiverModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_penerimaan_oprational_view,bottomreceiver);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_oprational_view);
        TextView Asset_Code_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_oprational_view);
        TextView Divisi_Asset_Receiver           = layout.findViewById(R.id.idTVType_receiver_oprational_view);
        TextView Amount_Receiver                 = layout.findViewById(R.id.idTVAmount_receiver_oprational_view);
        TextView Condition_Receiver            = layout.findViewById(R.id.idTVDesc_receiver_oprational_view);
        TextView Date_Receiver                   = layout.findViewById(R.id.idTVDate_receiver_oprational_view);
