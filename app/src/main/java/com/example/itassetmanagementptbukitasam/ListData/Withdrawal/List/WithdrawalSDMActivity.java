...
public class WithdrawalSDMActivity extends AppCompatActivity implements WithdrawalSDMAdapter.WithdrawalSDMAClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_withdrawal_sdm);


        swipeToRefresh();

        recyclerView = findViewById(R.id.with_data_sdm);
        floatingActionButton = findViewById(R.id.tambah_penarikan_sdm);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Withdrawal_sdm");
        withdrawalModelArrayList = new ArrayList<>();
        bottomWith = findViewById(R.id.idRLWithdrawal_sdm);
        loadingPB = findViewById(R.id.progress_bar_withdrawal_sdm);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_withrawal_sdm);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(WithdrawalSDMActivity.this, AddWithdrawalSDMActivity.class));
    ...
    private  void displayBottomShet(WithdrawalModel withdrawalModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_withdrawal_data_sdm,bottomWith);
        ...
        TextView WithCode           = layout.findViewById(R.id.idTVWithdrawalCode_sdm);
        TextView AssetCode      = layout.findViewById(R.id.idTVAssetCode_Withdrawal_sdm);
        TextView Date      = layout.findViewById(R.id.idTVDateWithdrawal_sdm);
        TextView Amount         = layout.findViewById(R.id.idTVAmountWithdrawal_sdm);
        TextView Division           = layout.findViewById(R.id.idTVDivisonWithdrawal_sdm);
        TextView Reason  = layout.findViewById(R.id.idTVReasonWithdrawal_sdm);
        TextView Officer         = layout.findViewById(R.id.idTVOfficerWithdrawal_sdm);
        TextView Description  = layout.findViewById(R.id.idTVDescriptionWithdrawal_sdm);

        Button editData = layout.findViewById(R.id.editDataWithdrawal_sdm);
        Button deleteData = layout.findViewById(R.id.DeleteDataWithdrawal_sdm);
        ...
        editData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(WithdrawalSDMActivity.this, EditWithdrawalSDM.class);
                i.putExtra("withdrawal_sdm", withdrawalModel);
                startActivity(i);
            }
        });
        ...
        deleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(WithdrawalSDMActivity.this, "Withdrawal deleted...", Toast.LENGTH_SHORT).show();
