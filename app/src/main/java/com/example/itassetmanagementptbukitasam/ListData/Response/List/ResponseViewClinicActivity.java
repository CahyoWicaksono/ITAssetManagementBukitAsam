...
public class ResponseViewClinicActivity extends AppCompatActivity implements ResponseClinicAdapter.ResponseClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_view_response);


        recyclerView            = findViewById(R.id.am_response_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Response_Clinic");
        responseModelArrayList = new ArrayList<>();
        bottomresponse            = findViewById(R.id.idRLResponse_view);
        loadingPB               = findViewById(R.id.progress_bar_response_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_response_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ResponseViewClinicActivity.this);
    ...
    private  void displayBottomShet(ResponseModel responseModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_view_response_data,bottomresponse);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name             = layout.findViewById(R.id.idTVNameResponse_view);
        TextView Date             = layout.findViewById(R.id.idTVDateResponse_view);
        TextView Division         = layout.findViewById(R.id.idTVDivisionResponse_view);
        TextView AssetName        = layout.findViewById(R.id.idTVAssetNameResponse_view);
        TextView Status           = layout.findViewById(R.id.idTVStatusResponse_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    ResponseViewClinicActivity.this);
            ...
            Toast.makeText(ResponseViewClinicActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
