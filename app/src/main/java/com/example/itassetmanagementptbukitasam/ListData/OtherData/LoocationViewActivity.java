...
public class LoocationViewActivity extends AppCompatActivity implements LocationAdapter.ViewDataLocationClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_location_aset_view);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.location_data_view);
        ...
        loadingPB               = findViewById(R.id.progress_bar_location_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_lokasi_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(LoocationViewActivity.this);
    ...
    private  void displayBottomShet(LocationModel locationModel){
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(LoocationViewActivity.this, EditLocation.class);
        ...
        deleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(LoocationViewActivity.this, "Damage Data deleted...", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(LoocationViewActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
