...
public class ViewWithdrawalActivity extends AppCompatActivity implements WithdrawalAdapter.WithdrawalClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_withdrawal_view);


        swipeToRefresh();

        recyclerView = findViewById(R.id.with_data_view);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Withdrawal");
        withdrawalModelArrayList = new ArrayList<>();
        bottomWith = findViewById(R.id.idRLWithdrawal_view);
        loadingPB = findViewById(R.id.progress_bar_withdrawal_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_withrawal_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ViewWithdrawalActivity.this);
    ...
    private  void displayBottomShet(WithdrawalModel withdrawalModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_withdrawal_data_view,bottomWith);
        ...
        TextView WithCode           = layout.findViewById(R.id.idTVWithdrawalCode_view);
        TextView AssetCode      = layout.findViewById(R.id.idTVAssetCode_Withdrawal_view);
        TextView Date      = layout.findViewById(R.id.idTVDateWithdrawal_view);
        TextView Amount         = layout.findViewById(R.id.idTVAmountWithdrawal_view);
        TextView Division           = layout.findViewById(R.id.idTVDivisonWithdrawal_view);
        TextView Reason  = layout.findViewById(R.id.idTVReasonWithdrawal_view);
        TextView Officer         = layout.findViewById(R.id.idTVOfficerWithdrawal_view);
        TextView Description  = layout.findViewById(R.id.idTVDescriptionWithdrawal_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(ViewWithdrawalActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
