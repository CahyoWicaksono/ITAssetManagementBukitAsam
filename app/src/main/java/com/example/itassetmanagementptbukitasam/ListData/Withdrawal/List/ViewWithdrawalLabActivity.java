...
public class ViewWithdrawalLabActivity extends AppCompatActivity implements WithdrawalLabAdapter.WithdrawalLabClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_withdrawal_view_lab);


        swipeToRefresh();

        recyclerView = findViewById(R.id.with_data_lab_view);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Withdrawal_lab");
        withdrawalModelArrayList = new ArrayList<>();
        bottomWith = findViewById(R.id.idRLWithdrawal_lab_view);
        loadingPB = findViewById(R.id.progress_bar_withdrawal_lab_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_withrawal_lab_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ViewWithdrawalLabActivity.this);
    ...
    private  void displayBottomShet(WithdrawalModel withdrawalModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_withdrawal_data_lab_view,bottomWith);
        ...
        TextView WithCode           = layout.findViewById(R.id.idTVWithdrawalCode_lab_view);
        TextView AssetCode      = layout.findViewById(R.id.idTVAssetCode_Withdrawal_lab_view);
        TextView Date      = layout.findViewById(R.id.idTVDateWithdrawal_lab_view);
        TextView Amount         = layout.findViewById(R.id.idTVAmountWithdrawal_lab_view);
        TextView Division           = layout.findViewById(R.id.idTVDivisonWithdrawal_lab_view);
        TextView Reason  = layout.findViewById(R.id.idTVReasonWithdrawal_lab_view);
        TextView Officer         = layout.findViewById(R.id.idTVOfficerWithdrawal_lab_view);
        TextView Description  = layout.findViewById(R.id.idTVDescriptionWithdrawal_lab_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    ViewWithdrawalLabActivity.this);
            ...
            Toast.makeText(ViewWithdrawalLabActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
