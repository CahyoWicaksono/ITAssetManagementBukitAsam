...
public class ViewReceiverClnicActivity extends AppCompatActivity implements ReceiverClinicAdapter.ViewDataClinicReceiverClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_penerimaan_clinic_view);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.penerimaan_data_clinic_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Receiver_clinic");
        receiverModelArrayList   = new ArrayList<>();
        bottomreceiver            = findViewById(R.id.idRLAset_receiver_clinic_view);
        loadingPB               = findViewById(R.id.progress_bar_receiver_clinic_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_receiver_clinic_view);
    ...
    private  void displayBottomShet(ReceiverModel receiverModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_penerimaan_clinic_view,bottomreceiver);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_clinic_view);
        TextView Asset_Code_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver_clinic_view);
        TextView Divisi_Asset_Receiver           = layout.findViewById(R.id.idTVType_receiver_clinic_view);
        TextView Amount_Receiver                 = layout.findViewById(R.id.idTVAmount_receiver_clinic_view);
        TextView Condition_Receiver            = layout.findViewById(R.id.idTVDesc_receiver_clinic_view);
        TextView Date_Receiver                   = layout.findViewById(R.id.idTVDate_receiver_clinic_view);
