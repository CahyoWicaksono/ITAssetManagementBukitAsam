...
public class ReceiverActivity extends AppCompatActivity implements ReceiverAdapter.ViewDataReceiverClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_penerimaan);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.penerimaan_data);
        floatingActionButton    = findViewById(R.id.tambah_receiver);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Receiver");
        receiverModelArrayList   = new ArrayList<>();
        bottomreceiver            = findViewById(R.id.idRLAset_receiver);
        loadingPB               = findViewById(R.id.progress_bar_receiver);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_receiver);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ReceiverActivity.this, AddReceiver.class));
    ...
    private  void displayBottomShet(ReceiverModel receiverModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_penerimaan,bottomreceiver);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver);
        TextView Asset_Code_Receiver             = layout.findViewById(R.id.idTVAssetName_receiver);
        TextView Divisi_Asset_Receiver           = layout.findViewById(R.id.idTVType_receiver);
        TextView Amount_Receiver                 = layout.findViewById(R.id.idTVAmount_receiver);
        TextView Condition_Receiver            = layout.findViewById(R.id.idTVDesc_receiver);
        TextView Date_Receiver                   = layout.findViewById(R.id.idTVDate_receiver);

        Button editData                         = layout.findViewById(R.id.editData_receiver);
        Button deleteData                       = layout.findViewById(R.id.DeleteData_receiver);
        ...
        editData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ReceiverActivity.this, EditReceiver.class);
                i.putExtra("receiver", receiverModel);
                startActivity(i);
            }
        });
        ...
        deleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ReceiverActivity.this, "Data deleted...", Toast.LENGTH_SHORT).show();
