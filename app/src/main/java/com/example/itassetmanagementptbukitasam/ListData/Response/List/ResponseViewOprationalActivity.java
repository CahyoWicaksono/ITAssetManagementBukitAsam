...
public class ResponseViewOprationalActivity extends AppCompatActivity implements ResponseOprationalAdapter.ResponseOprarionalClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_view_response_oprational);


        recyclerView            = findViewById(R.id.am_response_oprational_view);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Response_Oprational");
        responseModelArrayList = new ArrayList<>();
        bottomresponse            = findViewById(R.id.idRLResponseOprational_view);
        loadingPB               = findViewById(R.id.progress_bar_response_oprational_view);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_response_oprational_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ResponseViewOprationalActivity.this);
    ...
    private  void displayBottomShet(ResponseModel responseModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_view_response_oprational,bottomresponse);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name             = layout.findViewById(R.id.idTVNameResponseOprational_view);
        TextView Date             = layout.findViewById(R.id.idTVDateResponseOprational_view);
        TextView Division         = layout.findViewById(R.id.idTVDivisionResponseOprational_view);
        TextView AssetName        = layout.findViewById(R.id.idTVAssetNameResponseOprational_view);
        TextView Status           = layout.findViewById(R.id.idTVStatusResponseOprational_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    ResponseViewOprationalActivity.this);
            ...
            Toast.makeText(ResponseViewOprationalActivity.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
