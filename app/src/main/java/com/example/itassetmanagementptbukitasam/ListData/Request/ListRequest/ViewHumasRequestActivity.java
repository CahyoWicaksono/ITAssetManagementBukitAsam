...
public class ViewHumasRequestActivity extends AppCompatActivity implements RequestAdapter.ViewDataRequestClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_permintaan_view_humas);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.permintaan_data_view_humas);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Request_humas");
        requestModelArrayList = new ArrayList<>();
        bottomRequest            = findViewById(R.id.idRLAset_request_humas_view);
        loadingPB               = findViewById(R.id.progress_bar_request_view_humas);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_request_view_humas);
    ...
    private  void displayBottomShet(RequestModel requestModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_permintaan_view_humas,bottomRequest);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Request             = layout.findViewById(R.id.idTVAssetName_request_humas_view);
        TextView Asset_Code_Request             = layout.findViewById(R.id.idTVAssetName_request_humas_view);
        TextView Divisi_Asset_Request           = layout.findViewById(R.id.idTVType_request_humas_view);
        TextView Amount_Request                 = layout.findViewById(R.id.idTVAmount_request_humas_view);
        TextView Description_Request            = layout.findViewById(R.id.idTVDesc_request_humas_view);
        TextView Date_Request                   = layout.findViewById(R.id.idTVDate_request_humas_view);

        ImageView Image_Asset                   = layout.findViewById(R.id.image_asset_request_humas_view);
