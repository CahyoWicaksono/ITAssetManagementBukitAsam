...
public class ViewSDMRequestActivity extends AppCompatActivity implements RequestAdapter.ViewDataRequestClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_permintaan_view_sdm);

        swipeToRefresh();

        recyclerView            = findViewById(R.id.permintaan_data_view_sdm);
        firebaseDatabase        = FirebaseDatabase.getInstance();
        databaseReference       = firebaseDatabase.getReference("Request_sdm");
        requestModelArrayList = new ArrayList<>();
        bottomRequest            = findViewById(R.id.idRLAset_request_view_sdm);
        loadingPB               = findViewById(R.id.progress_bar_request_view_sdm);
        ...
        bottomNavigationView = findViewById(R.id.botomNavigation_request_view_sdm);
    ...
    private  void displayBottomShet(RequestModel requestModel){
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_data_permintaan_view_sdm,bottomRequest);
        bottomSheetDialog.setContentView(layout);
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        bottomSheetDialog.show();

        TextView Name_Asset_Request             = layout.findViewById(R.id.idTVAssetName_request_view_sdm);
        TextView Asset_Code_Request             = layout.findViewById(R.id.idTVAssetName_request_view_sdm);
        TextView Divisi_Asset_Request           = layout.findViewById(R.id.idTVType_request_view_sdm);
        TextView Amount_Request                 = layout.findViewById(R.id.idTVAmount_request_view_sdm);
        TextView Description_Request            = layout.findViewById(R.id.idTVDesc_request_view_sdm);
        TextView Date_Request                   = layout.findViewById(R.id.idTVDate_request_view_sdm);

        ImageView Image_Asset                   = layout.findViewById(R.id.image_asset_request_view_sdm);
