...
public class EditReceiverLab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan_lab);



        nameReceiver = findViewById(R.id.et_name_penerimaan_Update_lab);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_lab);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_Update_lab);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_Update_lab);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_Update_lab);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_lab);


        btn_update_request = findViewById(R.id.btn_Update_penerimaan_lab);
        backas = findViewById(R.id.back_penerimaan_lab);

        firebaseDatabase =FirebaseDatabase.getInstance();
        receiverModel = getIntent().getParcelableExtra("receiver_lab");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver_lab").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiverLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiverLab.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiverLab.this, ReceiverLabActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiverLab.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
