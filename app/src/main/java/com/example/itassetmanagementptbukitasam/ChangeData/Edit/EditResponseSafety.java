...
public class EditResponseSafety extends AppCompatActivity {
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_response_safety);

        nameResponse = findViewById(R.id.et_name_response_safety_update);
        dateResponse = findViewById(R.id.et_date_response_safety_update);
        divisionResponse = findViewById(R.id.et_division_response_safety_update);
        assetResponse = findViewById(R.id.et_name_asset_response_safety_update);
        backdmg = findViewById(R.id.back_response_safety_update);

        update_response = findViewById(R.id.btn_submit_safety_update);
        radioGroupUdateStatus = findViewById(R.id.radio_group_response_safety_update);

        firebaseDatabase =FirebaseDatabase.getInstance();
        responseModel = getIntent().getParcelableExtra("response_safety");
        ...
        databaseReference = firebaseDatabase.getReference("Response_Safety").child(ResponseID);
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResponseSafety.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            Toast.makeText(EditResponseSafety.this, "Data Updated...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(EditResponseSafety.this, ResponsesSafetyActivity.class));

                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(EditResponseSafety.this, "Data Updated Failed...", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
