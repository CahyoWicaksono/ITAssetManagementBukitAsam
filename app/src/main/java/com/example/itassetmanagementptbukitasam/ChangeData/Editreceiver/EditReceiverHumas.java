...
public class EditReceiverHumas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan_humas);



        nameReceiver = findViewById(R.id.et_name_penerimaan_Update);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_Update);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_Update);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_Update);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update);


        btn_update_request = findViewById(R.id.btn_Update_penerimaan);
        backas = findViewById(R.id.back_penerimaan);

        firebaseDatabase =FirebaseDatabase.getInstance();
        receiverModel = getIntent().getParcelableExtra("receiver_humas");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver_humas").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiverHumas.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiverHumas.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiverHumas.this, ReceiverActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiverHumas.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
