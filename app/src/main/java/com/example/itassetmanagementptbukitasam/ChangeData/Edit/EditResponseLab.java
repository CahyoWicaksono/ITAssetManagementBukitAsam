...
public class EditResponseLab extends AppCompatActivity {
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_response_lab);

        nameResponse = findViewById(R.id.et_name_response_lab_update);
        dateResponse = findViewById(R.id.et_date_response_lab_update);
        divisionResponse = findViewById(R.id.et_division_response_lab_update);
        assetResponse = findViewById(R.id.et_name_asset_response_lab_update);
        backdmg = findViewById(R.id.back_response_lab_update);

        update_response = findViewById(R.id.btn_submit_lab_update);
        radioGroupUdateStatus = findViewById(R.id.radio_group_response_lab_update);

        firebaseDatabase =FirebaseDatabase.getInstance();
        responseModel = getIntent().getParcelableExtra("response_lab");
        ...
        databaseReference = firebaseDatabase.getReference("Response_Lab").child(ResponseID);
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResponseLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            Toast.makeText(EditResponseLab.this, "Data Updated...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(EditResponseLab.this, ResponseLabActivity.class));

                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(EditResponseLab.this, "Data Updated Failed...", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
