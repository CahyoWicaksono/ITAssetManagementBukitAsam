...
public class EditResponseOprational extends AppCompatActivity {
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_response_oprational);

        nameResponse = findViewById(R.id.et_name_response_oprational_update);
        dateResponse = findViewById(R.id.et_date_response_oprational_update);
        divisionResponse = findViewById(R.id.et_division_response_oprational_update);
        assetResponse = findViewById(R.id.et_name_asset_response_oprational_update);
        backdmg = findViewById(R.id.back_response_oprational_update);

        update_response = findViewById(R.id.btn_submit_oprational_update);
        radioGroupUdateStatus = findViewById(R.id.radio_group_response_oprational_update);

        firebaseDatabase =FirebaseDatabase.getInstance();
        responseModel = getIntent().getParcelableExtra("response_oprational");
        ...
        databaseReference = firebaseDatabase.getReference("Response_Oprational").child(ResponseID);
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResponseOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            Toast.makeText(EditResponseOprational.this, "Data Updated...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(EditResponseOprational.this, ResponseOprationalActivity.class));
                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(EditResponseOprational.this, "Damage Updated Failed...", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
