...
public class EditAssetClinic extends AppCompatActivity {
    EditText kode_aset, nama_aset, jenis, merk, spesifikasi, jumlah, supply, link, datePurchase,period,nextPeriod,purchase;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_asset_clinic);

        nama_aset = findViewById(R.id.et_nama_aset_clinic_update);
        kode_aset = findViewById(R.id.et_kode_aset_clinic_update);
        merk = findViewById(R.id.et_merk_clinic_update);
        jenis = findViewById(R.id.et_jenis_clinic_update);
        spesifikasi = findViewById(R.id.et_spesifikasi_clinic_update);
        jumlah = findViewById(R.id.et_jumlah_clinic_update);
        supply = findViewById(R.id.et_Supply_clinic_update);
        period = findViewById(R.id.et_datePeriod_clinic_update);
        nextPeriod = findViewById(R.id.et_dateEndPeriod_clinic_update);
        purchase = findViewById(R.id.et_datePurchase_clinic_update);
        link = findViewById(R.id.et_link_image_clinic_update);



        backas = findViewById(R.id.backin_clinic_update);
        btn_update_aset = findViewById(R.id.btn_asset_clinic_update);

        btn_purchase = findViewById(R.id.btn_purchase_date_clinic);
        btn_EndPeriod = findViewById(R.id.btn_period_date_clinic_update);
        btn_period = findViewById(R.id.btn_end_period_date_clinic_update);


        firebaseDatabase =FirebaseDatabase.getInstance();
        assetModel = getIntent().getParcelableExtra("receiver_clinic");
        ...
        databaseReference = firebaseDatabase.getReference("Asset_Clinic").child(assetID);
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditAssetClinic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditAssetClinic.this, "Asset Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditAssetClinic.this, AssetDataClinicActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditAssetClinic.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
