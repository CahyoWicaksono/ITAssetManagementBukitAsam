...
public class EditAssetHumas extends AppCompatActivity {
    EditText kode_aset, nama_aset, jenis, merk, spesifikasi, link, jumlah, supply, datePurchase,period,nextPeriod,purchase;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_asset_humas);

        nama_aset = findViewById(R.id.et_nama_aset_humas_update);
        kode_aset = findViewById(R.id.et_kode_aset_humas_update);
        merk = findViewById(R.id.et_merk_humas_update);
        jenis = findViewById(R.id.et_jenis_humas_update);
        spesifikasi = findViewById(R.id.et_spesifikasi_humas_update);
        jumlah = findViewById(R.id.et_jumlah_humas_update);
        supply = findViewById(R.id.et_Supply_humas_update);
        period = findViewById(R.id.et_datePeriod_humas_update);
        nextPeriod = findViewById(R.id.et_dateEndPeriod_humas_update);
        purchase = findViewById(R.id.et_datePurchase_humas_update);
        link = findViewById(R.id.et_link_image_humas_update);

        backas = findViewById(R.id.backin_humas_update);
        btn_update_aset = findViewById(R.id.btn_update_humas);

        btn_purchase = findViewById(R.id.btn_purchase_date_humas_update);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_humas_update);
        btn_period = findViewById(R.id.btn_end_period_date_humas_update);
        ...
        databaseReference = firebaseDatabase.getReference("Asset_Humas").child(assetID);
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditAssetHumas.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditAssetHumas.this, "Asset Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditAssetHumas.this, AssetDataHumasActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditAssetHumas.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
