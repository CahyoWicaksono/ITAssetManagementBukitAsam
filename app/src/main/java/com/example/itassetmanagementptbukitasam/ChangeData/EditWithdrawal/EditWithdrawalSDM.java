...
public class EditWithdrawalSDM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_withdrawal_sdm);

        kode_penarikan = findViewById(R.id.et_with_code_sdm_update);
        kode_aset = findViewById(R.id.et_kode_aset_sdm_update);
        tanggal = findViewById(R.id.et_tanggal_with_sdm_update);
        devisi = findViewById(R.id.et_devisi_with_sdm_update);
        alasan = findViewById(R.id.et_reason_with_sdm_update);
        keterangan_penarikan = findViewById(R.id.et_desc_with_sdm_update);
        jumlah_penarikan= findViewById(R.id.et_amount_with_sdm_update);
        petugas = findViewById(R.id.et_officer_with_sdm_update);


        backwith = findViewById(R.id.backwith_sdm_update);
        withdrawalDate = findViewById(R.id.with_date_sdm_update);

        btn_update_with = findViewById(R.id.btn_simpan_with_sdm_update);
        firebaseDatabase =FirebaseDatabase.getInstance();
        withdrawalModel = getIntent().getParcelableExtra("withdrawal_sdm");
        ...
        if(withdrawalModel!=null){
            ...
            withSDMId = withdrawalModel.getDevisi();

        }
        databaseReference = firebaseDatabase.getReference("Withdrawal_sdm").child(withSDMId);
        ...
        withdrawalDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditWithdrawalSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_update_with.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Withdrawal.put("withSDMId",withSDMId);

                databaseReference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.updateChildren(Withdrawal);
                        Toast.makeText(EditWithdrawalSDM.this, "Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditWithdrawalSDM.this, WithdrawalSDMActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditWithdrawalSDM.this, "Fail To Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                    }
                });
