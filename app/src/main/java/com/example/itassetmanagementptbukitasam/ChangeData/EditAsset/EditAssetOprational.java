...
public class EditAssetOprational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_asset_oprational);

        nama_aset = findViewById(R.id.et_nama_aset_oprational_update);
        kode_aset = findViewById(R.id.et_kode_aset_oprational_update);
        merk = findViewById(R.id.et_merk_oprational_update);
        jenis = findViewById(R.id.et_jenis_oprational_update);
        spesifikasi = findViewById(R.id.et_spesifikasi_oprational_update);
        jumlah = findViewById(R.id.et_jumlah_oprational_update);
        supply = findViewById(R.id.et_supplier_oprational_update);
        period = findViewById(R.id.et_datePeriod_oprational_update);
        nextPeriod = findViewById(R.id.et_dateEndPeriod_oprational_update);
        purchase = findViewById(R.id.et_datePurchase_oprational_update);
        link = findViewById(R.id.et_link_oprational_update);


        backas = findViewById(R.id.backAs_update_oprational);
        btn_update_aset = findViewById(R.id.btn_update_aset_oprational_update);

        btn_purchase = findViewById(R.id.purchase_date_oprational_update);
        btn_EndPeriod = findViewById(R.id.end_period_date_oprational_update);
        btn_period = findViewById(R.id.period_date_oprational_update);
        ...
        databaseReference = firebaseDatabase.getReference("Asset_Oprational").child(assetID);
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditAssetOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditAssetOprational.this, "Asset Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditAssetOprational.this, AssetOprationalActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditAssetOprational.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
