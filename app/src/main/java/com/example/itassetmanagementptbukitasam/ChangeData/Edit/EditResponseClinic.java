...
public class EditResponseClinic extends AppCompatActivity {
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_response);

        nameResponse = findViewById(R.id.et_name_response_update);
        dateResponse = findViewById(R.id.et_date_response_update);
        divisionResponse = findViewById(R.id.et_division_response_update);
        assetResponse = findViewById(R.id.et_name_asset_response_update);
        backdmg = findViewById(R.id.back_response_update);

        update_response = findViewById(R.id.btn_submit_response_update);
        radioGroupUdateStatus = findViewById(R.id.radio_group_response_update);

        firebaseDatabase =FirebaseDatabase.getInstance();
        responseModel = getIntent().getParcelableExtra("response_clinic");
        ...
        databaseReference = firebaseDatabase.getReference("Response_Clinic").child(ResponseID);
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResponseClinic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            Toast.makeText(EditResponseClinic.this, "Data Updated...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(EditResponseClinic.this, ResponseClinicActivity.class));

                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(EditResponseClinic.this, "Data Updated Failed...", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
