...
public class EditWithdrawalLogistic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_withdrawal_logistic);

        kode_penarikan = findViewById(R.id.et_with_code_logistic_update);
        kode_aset = findViewById(R.id.et_kode_aset_logistic_update);
        tanggal = findViewById(R.id.et_tanggal_with_logistic_update);
        devisi = findViewById(R.id.et_devisi_with_logistic_update);
        alasan = findViewById(R.id.et_reason_with_logistic_update);
        keterangan_penarikan = findViewById(R.id.et_desc_with_logistic_update);
        jumlah_penarikan= findViewById(R.id.et_amount_with_logistic_update);
        petugas = findViewById(R.id.et_officer_with_logistic_update);

        backwith = findViewById(R.id.backwith_logistic_update);
        withdrawalDate = findViewById(R.id.with_date_logistic_update);

        btn_update_with = findViewById(R.id.btn_update_with);
        firebaseDatabase =FirebaseDatabase.getInstance();
        withdrawalModel = getIntent().getParcelableExtra("withdrawal_logistic");
        ...
        if(withdrawalModel!=null){
            ...
            withlogisticId = withdrawalModel.getDevisi();

        }
        databaseReference = firebaseDatabase.getReference("Withdrawal_logistic").child(withlogisticId);
        ...
        withdrawalDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditWithdrawalLogistic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_update_with.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Withdrawal.put("withId",withlogisticId);

                databaseReference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.updateChildren(Withdrawal);
                        Toast.makeText(EditWithdrawalLogistic.this, "Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditWithdrawalLogistic.this, WithdrawalLogisticActivity.class));
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditWithdrawalLogistic.this, "Fail To Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                    }
                });
