...
public class EditReceiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan);
        ...
        receiverModel = getIntent().getParcelableExtra("receiver");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiver.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiver.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiver.this, ReceiverActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiver.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
