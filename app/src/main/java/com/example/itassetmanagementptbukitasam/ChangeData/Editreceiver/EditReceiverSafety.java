...
public class EditReceiverSafety extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan_safety);



        nameReceiver = findViewById(R.id.et_name_penerimaan_Update);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_safety);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_Update_safety);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_Update_safety);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_Update_safety);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_safety);


        btn_update_request = findViewById(R.id.btn_Update_penerimaan_safety);
        backas = findViewById(R.id.back_penerimaan_safety);

        firebaseDatabase =FirebaseDatabase.getInstance();
        receiverModel = getIntent().getParcelableExtra("receiver_safety");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver_safety").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiverSafety.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiverSafety.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiverSafety.this, ReceiverSafetyActivity.class));
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiverSafety.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
