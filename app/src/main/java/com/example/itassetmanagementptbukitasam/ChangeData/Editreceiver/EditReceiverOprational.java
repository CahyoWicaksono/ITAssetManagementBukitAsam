...
public class EditReceiverOprational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan_oprational);



        nameReceiver = findViewById(R.id.et_name_penerimaan_Update_oprational);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_oprational);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_Update_oprational);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_Update_oprational);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_Update_oprational);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_oprational);


        btn_update_request = findViewById(R.id.btn_Update_penerimaan_oprational);
        backas = findViewById(R.id.back_penerimaan_oprational);

        firebaseDatabase =FirebaseDatabase.getInstance();
        receiverModel = getIntent().getParcelableExtra("receiver_oprational");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver_oprational").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiverOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiverOprational.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiverOprational.this, ReceiverOprationalActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiverOprational.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
