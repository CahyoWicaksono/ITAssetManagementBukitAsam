...
public class EditAssetSDM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_asset_sdm);

        nama_aset = findViewById(R.id.et_nama_aset_update_complaint);
        kode_aset = findViewById(R.id.et_kode_aset_update_complaint);
        merk = findViewById(R.id.et_merk_update_complaint);
        jenis = findViewById(R.id.et_jenis_update_complaint);
        spesifikasi = findViewById(R.id.et_spesifikasi_update_complaint);
        jumlah = findViewById(R.id.et_jumlah_update_complaint);
        supply = findViewById(R.id.et_supplier_update_complaint);
        period = findViewById(R.id.et_datePeriod_update_complaint);
        nextPeriod = findViewById(R.id.et_dateEndPeriod_update_complaint);
        purchase = findViewById(R.id.et_datePurchase_update_complaint);
        link = findViewById(R.id.et_link_asset_update_complaint);


        backas = findViewById(R.id.back_update_complaint);
        btn_update_aset = findViewById(R.id.btn_update_aset_complaint);

        btn_purchase = findViewById(R.id.purchase_date_update_complaint);
        btn_EndPeriod = findViewById(R.id.end_period_date_update_complaint);
        btn_period = findViewById(R.id.period_date_update_complaint);
        ...
        databaseReference = firebaseDatabase.getReference("Asset_SDM").child(assetID);
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditAssetSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditAssetSDM.this, "Asset Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditAssetSDM.this, AssetDataSDMActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditAssetSDM.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
