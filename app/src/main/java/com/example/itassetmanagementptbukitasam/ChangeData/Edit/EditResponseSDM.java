...
public class EditResponseSDM extends AppCompatActivity {
    boolean valid = true;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_response_sdm);

        nameResponse = findViewById(R.id.et_name_response_sdm_update);
        dateResponse = findViewById(R.id.et_date_response_sdm_update);
        divisionResponse = findViewById(R.id.et_division_response_sdm_update);
        assetResponse = findViewById(R.id.et_name_asset_response_sdm_update);
        backdmg = findViewById(R.id.back_response_sdm_update);

        update_response = findViewById(R.id.btn_submit_response_sdm_update);
        radioGroupUdateStatus = findViewById(R.id.radio_group_response_sdm_update);

        firebaseDatabase =FirebaseDatabase.getInstance();
        responseModel = getIntent().getParcelableExtra("response_sdm");
        ...
        databaseReference = firebaseDatabase.getReference("Response_SDM").child(ResponseID);
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResponseSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            Toast.makeText(EditResponseSDM.this, "Data Updated...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(EditResponseSDM.this, ResponseSDMActivity.class));

                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(EditResponseSDM.this, "Data Updated Failed...", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
