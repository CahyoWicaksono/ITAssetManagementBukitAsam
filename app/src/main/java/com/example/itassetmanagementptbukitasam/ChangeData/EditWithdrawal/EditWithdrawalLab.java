...
public class EditWithdrawalLab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_withdrawal_lab);

        kode_penarikan = findViewById(R.id.et_with_code_lab_update);
        kode_aset = findViewById(R.id.et_kode_aset_lab_update);
        tanggal = findViewById(R.id.et_tanggal_with_lab_update);
        devisi = findViewById(R.id.et_devisi_with_lab_update);
        alasan = findViewById(R.id.et_reason_lab_update);
        keterangan_penarikan = findViewById(R.id.et_desc_with_lab_update);
        jumlah_penarikan= findViewById(R.id.et_amount_with_lab_update);
        petugas = findViewById(R.id.et_officer_with_lab_update);

        backwith = findViewById(R.id.backwith_lab_update);
        withdrawalDate = findViewById(R.id.with_date_lab_update);

        btn_update_with = findViewById(R.id.btn_simpan_with_lab);
        firebaseDatabase =FirebaseDatabase.getInstance();
        withdrawalModel = getIntent().getParcelableExtra("withdrawal_lab");
        ...
        if(withdrawalModel!=null){
            ...
            withLabId = withdrawalModel.getDevisi();

        }
        databaseReference = firebaseDatabase.getReference("Withdrawal_lab").child(withLabId);
        ...
        withdrawalDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditWithdrawalLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_update_with.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Withdrawal.put("withId",withLabId);

                databaseReference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.updateChildren(Withdrawal);
                        Toast.makeText(EditWithdrawalLab.this, "Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditWithdrawalLab.this, WithdrawalLabActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditWithdrawalLab.this, "Fail To Withdrawal Data Updated...", Toast.LENGTH_SHORT).show();
                    }
                });
