...
public class EditAssetLogistic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_asset_logistic);

        nama_aset = findViewById(R.id.et_nama_aset_logistic_update);
        kode_aset = findViewById(R.id.et_kode_aset_logistic_update);
        merk = findViewById(R.id.et_merk_logistic_update);
        jenis = findViewById(R.id.et_jenis_logistic_update);
        spesifikasi = findViewById(R.id.et_spesifikasi_logistic_update);
        jumlah = findViewById(R.id.et_jumlah_logistic_update);
        supply = findViewById(R.id.et_supplier_logistic_update);
        period = findViewById(R.id.et_datePeriod_logistic_update);
        nextPeriod = findViewById(R.id.et_dateEndPeriod_logistic_update);
        purchase = findViewById(R.id.et_datePurchase_logistic_update);
        link = findViewById(R.id.et_link_logistic_update);


        backas = findViewById(R.id.back_logistic_update);
        btn_update_aset = findViewById(R.id.btn_update_aset_logistic_update);

        btn_purchase = findViewById(R.id.purchase_date_logistic_update);
        btn_EndPeriod = findViewById(R.id.end_period_date_logistic_update);
        btn_period = findViewById(R.id.period_date_logistic_update);
        ...
        databaseReference = firebaseDatabase.getReference("Asset_Logistic").child(assetID);
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditAssetLogistic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditAssetLogistic.this, "Asset Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditAssetLogistic.this,AssetDataLogisticActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditAssetLogistic.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
