...
public class EditReceiverSDM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.update_penerimaan_sdm);



        nameReceiver = findViewById(R.id.et_name_penerimaan_Update_sdm);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_sdm);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_Update_sdm);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_Update_sdm);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_Update_sdm);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_Update_sdm);


        btn_update_request = findViewById(R.id.btn_Update_penerimaan_sdm);
        backas = findViewById(R.id.back_penerimaan_sdm);

        firebaseDatabase =FirebaseDatabase.getInstance();
        receiverModel = getIntent().getParcelableExtra("receiver_sdm");
        ...
        databaseReference = firebaseDatabase.getReference("Receiver_sdm").child(ReceiverID);
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditReceiverSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditReceiverSDM.this, " Data Updated...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditReceiverSDM.this, ReceiverActivity.class));

                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditReceiverSDM.this, "Update Data Failed", Toast.LENGTH_SHORT).show();
                    }
                });
