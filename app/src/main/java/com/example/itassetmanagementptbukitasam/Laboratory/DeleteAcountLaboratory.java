...
public class DeleteAcountLaboratory extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_lab_account);


        progressBar = findViewById(R.id.progressBar_lab);
        editTextUserPwd = findViewById(R.id.editText_delete_user_pwd_lab);
        textViewAutenticate = findViewById(R.id.textView_delete_user_authenticated_lab);
        buttonDeleteUser = findViewById(R.id.button_delete_lab);
        buttonReAutenticate = findViewById(R.id.button_delete_admin_authenticate_lab);

        backDel = findViewById(R.id.back_delete_account_lab);
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(DeleteAcountLaboratory.this, "Something went wrong !" +
                    "User details are not available at the moment", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(DeleteAcountLaboratory.this, ProfileLabActivity.class);
    ...
    private void reAutenticated(FirebaseUser firebaseUser) {
        Button verifyUser = findViewById(R.id.button_delete_admin_authenticate_lab);
        verifyUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userPwd)){
                    Toast.makeText(DeleteAcountLaboratory.this, "Password is needed to continue", Toast.LENGTH_SHORT).show();
                    ...
                    firebaseUser.reauthenticate(authCredential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(DeleteAcountLaboratory.this, "Password has been verified" +
                                ...
                                buttonDeleteUser.setBackgroundTintList(ContextCompat.getColorStateList(DeleteAcountLaboratory.this,
                                        R.color.red));
                                ...
                                try {
                                    ...
                                    Toast.makeText(DeleteAcountLaboratory.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
    ...
    private void showAlertDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DeleteAcountLaboratory.this);
        ...
        firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    deleteUserData();
                    auth.signOut();
                    Toast.makeText(DeleteAcountLaboratory.this, "User has been deleted!!",
                            Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(DeleteAcountLaboratory.this, SignInActivity.class);
                    startActivity(intent);
                    finish();
                }else {
                    try {
