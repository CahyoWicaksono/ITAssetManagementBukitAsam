...
public class AddComplaintLab extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String ComplaintID;
    private static final String TAG = "AddComplaintLab";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_complain_lab);


        namaPengadu = findViewById(R.id.et_name_complaint_lab);
        tanggalPengadu = findViewById(R.id.et_date_complaint_lab);
        Divisi = findViewById(R.id.et_division_complaint_lab);
        NamaAset = findViewById(R.id.et_name_asset_complaint_lab);
        Problem = findViewById(R.id.et_problem_complaint_lab);


        backmaintenance = findViewById(R.id.back_complaint_lab);

        btn_simpan = findViewById(R.id.btn_submit_lab);
        ...
        tanggalPengadu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddComplaintLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddComplaintLab.this, LabHome.class));
