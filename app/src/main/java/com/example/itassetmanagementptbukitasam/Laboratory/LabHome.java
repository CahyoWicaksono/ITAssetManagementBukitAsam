...
import com.example.itassetmanagementptbukitasam.Humas.AddComplaintHumas;
...
import com.example.itassetmanagementptbukitasam.Humas.UpdateProfileHumasActivity;
import com.example.itassetmanagementptbukitasam.ListData.Receiver.ListReceiver.ReceiverHumasActivity;
import com.example.itassetmanagementptbukitasam.ListData.Receiver.ListReceiver.ReceiverLabActivity;
...
import com.example.itassetmanagementptbukitasam.ListData.Response.List.ResponseViewHumasActivity;
import com.example.itassetmanagementptbukitasam.ListData.Response.List.ResponseViewLabActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalHumasActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalLabActivity;
...
public class LabHome extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        menuComplain = findViewById(R.id.complaint_lab);
        menuWith = findViewById(R.id.withdrawal_lab);
        menuRequest = findViewById(R.id.request_lab);
        menuReceiver = findViewById(R.id.receiver_lab);
        menuResposnse = findViewById(R.id.response_lab);

        database = findViewById(R.id.database_progress_lab);
        qrprogress = findViewById(R.id.qr_progress_lab);
        schedule = findViewById(R.id.schedule_progress_lab);
        damageProgress = findViewById(R.id.damage_progress_lab);
        information = findViewById(R.id.information_asset_lab);

        location_admin = findViewById(R.id.location_lab);
        slider_admin = findViewById(R.id.Slidder_lab);

        auth = FirebaseAuth.getInstance();


        bottomNavigationView = findViewById(R.id.botomNavigationView_lab);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(LabHome.this);
        ...
        setting=findViewById(R.id.setting_lab);
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SettingLabActivity.class);
        ...
        information.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(LabHome.this)
                        .setTitle("Features")
        ...
        menuComplain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddComplaintLab.class);
                startActivity(intent);
                finish();
            }
        });
        menuWith.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ViewWithdrawalLabActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuResposnse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ResponseViewLabActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RequestLabActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuReceiver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ReceiverLabActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(LabHome.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
