...
public class AddResponseOprational extends AppCompatActivity {
    ...
    private static final String TAG = "AddResponseOprational";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_response_oprational);

        nameResponse = findViewById(R.id.et_name_response_oprational);
        dateResponse = findViewById(R.id.et_date_response_oprational);
        divisionResponse = findViewById(R.id.et_division_response_oprational);
        assetResponse = findViewById(R.id.et_name_asset_response_oprational);
        radioGroupStatusResponse = findViewById(R.id.radio_group_response_oprational);

        btn_save = findViewById(R.id.btn_submit_response_oprational);
        backcom = findViewById(R.id.back_response_oprational);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Response_Oprational");
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddResponseOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddResponseOprational.this, ResponseOprationalActivity.class));
