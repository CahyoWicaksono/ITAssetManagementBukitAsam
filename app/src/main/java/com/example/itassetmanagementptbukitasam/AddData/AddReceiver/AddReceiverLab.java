...
public class AddReceiverLab extends AppCompatActivity {
    ...
    private static final String TAG = "AddReceiverLab";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_penerimaan_lab);

        nameReceiver = findViewById(R.id.et_name_penerimaan_lab);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_lab);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_lab);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_lab);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_lab);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_lab);
        link = findViewById(R.id.et_link_image_penerimaan_lab);


        btn_save = findViewById(R.id.btn_simpan_penerimaan_lab);
        backcom = findViewById(R.id.back_penerimaan_lab);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_lab");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverLab.this, ReceiverLabActivity.class));
