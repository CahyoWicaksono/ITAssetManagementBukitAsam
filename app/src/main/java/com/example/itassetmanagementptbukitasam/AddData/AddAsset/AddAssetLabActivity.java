...
public class AddAssetLabActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetLabActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_lab);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_lab);
        nama_aset = findViewById(R.id.et_nama_aset_lab);
        supply = findViewById(R.id.et_Supply_lab);
        datePurchase = findViewById(R.id.et_datePurchase_lab);
        period = findViewById(R.id.et_datePeriod_lab);
        nextperiod = findViewById(R.id.et_dateEndPeriod_lab);
        jenis = findViewById(R.id.et_jenis_lab);
        merk = findViewById(R.id.et_merk_lab);
        spesifikasi = findViewById(R.id.et_spesifikasi_lab);
        jumlah = findViewById(R.id.et_jumlah_lab);
        link = findViewById(R.id.et_link_image_lab);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_lab);
        btn_period = findViewById(R.id.btn_period_date_lab);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_lab);
        backasset = findViewById(R.id.backinAsset_lab);
        btn_simpan = findViewById(R.id.btn_simpan_lab);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_Laboratory");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetLabActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backasset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AssetDataLabActivity.class);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetLabActivity.this, AssetDataLabActivity.class));
