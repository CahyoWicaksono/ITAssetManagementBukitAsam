...
public class AddResponseSDM extends AppCompatActivity {
    ...
    private static final String TAG = "AddResponseSDM";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_response_sdm);

        nameResponse = findViewById(R.id.et_name_response_sdm);
        dateResponse = findViewById(R.id.et_date_response_sdm);
        divisionResponse = findViewById(R.id.et_division_response_sdm);
        assetResponse = findViewById(R.id.et_name_asset_response_sdm);
        radioGroupStatusResponse = findViewById(R.id.radio_group_response_sdm);

        btn_save = findViewById(R.id.btn_submit_response_sdm);
        backcom = findViewById(R.id.back_response_sdm);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Response_SDM");
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddResponseSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddResponseSDM.this, ResponseSDMActivity.class));
                            ResponseModel responseModel = snapshot.getValue(ResponseModel.class);
                            Log.d(TAG, "Create response asset successfull  " + responseModel);
                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Log.w(TAG, "Failed to read response.", error.toException());
