...
public class AddResponseLogistic extends AppCompatActivity {
    ...
    private static final String TAG = "AddResponseLogistic";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_response_logistic);

        nameResponse = findViewById(R.id.et_name_response_logistic);
        dateResponse = findViewById(R.id.et_date_response_logistic);
        divisionResponse = findViewById(R.id.et_division_response_logistic);
        assetResponse = findViewById(R.id.et_name_asset_response_logistic);
        radioGroupStatusResponse = findViewById(R.id.radio_group_response_logistic);

        btn_save = findViewById(R.id.btn_submit_response_logistic);
        backcom = findViewById(R.id.back_response_logistic);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Response_Logistic");
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddResponseLogistic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddResponseLogistic.this, ResponseLogisticActivity.class));
