...
public class AddAssetClinicActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetClinicActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_clinic);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_clinic);
        nama_aset = findViewById(R.id.et_nama_aset_clinic);
        supply = findViewById(R.id.et_Supply_clinic);
        datePurchase = findViewById(R.id.et_datePurchase_clinic);
        period = findViewById(R.id.et_datePeriod_clinic);
        nextperiod = findViewById(R.id.et_dateEndPeriod_clinic);
        jenis = findViewById(R.id.et_jenis_clinic);
        merk = findViewById(R.id.et_merk_clinic);
        spesifikasi = findViewById(R.id.et_spesifikasi_clinic);
        jumlah = findViewById(R.id.et_jumlah_clinic);
        link = findViewById(R.id.et_link_image_clinic);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_clinic);
        btn_period = findViewById(R.id.btn_period_date_clinic);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_clinic);
        backasset = findViewById(R.id.backin_clinic);
        btn_simpan = findViewById(R.id.btn_simpan_clinic);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_Clinic");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetClinicActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backasset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AssetDataClinicActivity.class);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetClinicActivity.this, AssetDataClinicActivity.class));
