...
public class AddAssetHumasActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetHumasActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_humas);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_humas);
        nama_aset = findViewById(R.id.et_nama_aset_humas);
        supply = findViewById(R.id.et_Supply_humas);
        datePurchase = findViewById(R.id.et_datePurchase_humas);
        period = findViewById(R.id.et_datePeriod_humas);
        nextperiod = findViewById(R.id.et_dateEndPeriod_humas);
        jenis = findViewById(R.id.et_jenis_humas);
        merk = findViewById(R.id.et_merk_humas);
        spesifikasi = findViewById(R.id.et_spesifikasi_humas);
        jumlah = findViewById(R.id.et_jumlah_humas);
        link = findViewById(R.id.et_link_image_humas);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_humas);
        btn_period = findViewById(R.id.btn_period_date_humas);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_humas);
        backasset = findViewById(R.id.backin_humas);
        btn_simpan = findViewById(R.id.btn_simpan_humas);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_Humas");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetHumasActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backasset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AssetDataHumasActivity.class);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetHumasActivity.this, AssetDataHumasActivity.class));
