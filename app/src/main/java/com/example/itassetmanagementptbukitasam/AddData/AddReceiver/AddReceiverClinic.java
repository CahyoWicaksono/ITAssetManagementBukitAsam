...
public class AddReceiverClinic extends AppCompatActivity {
    ...
    private static final String TAG = "AddReceiverClinic";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_penerimaan_clinic);

        nameReceiver = findViewById(R.id.et_name_penerimaan_clinic);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_clinic);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_clinic);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_clinic);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_clinic);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_clinic);


        btn_save = findViewById(R.id.btn_simpan_penerimaan_clinic);
        backcom = findViewById(R.id.back_penerimaan_clinic);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_clinic");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverClinic.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverClinic.this, ReceiverClnicActivity.class));
