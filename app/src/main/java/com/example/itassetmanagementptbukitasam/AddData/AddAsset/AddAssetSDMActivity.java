...
public class AddAssetSDMActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetSDMActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_sdm);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_complaint);
        nama_aset = findViewById(R.id.et_nama_aset_complaint);
        supply = findViewById(R.id.et_Supply_complaint);
        datePurchase = findViewById(R.id.et_datePurchase_complaint);
        period = findViewById(R.id.et_datePeriod_complaint);
        nextperiod = findViewById(R.id.et_dateEndPeriod_complaint);
        jenis = findViewById(R.id.et_jenis_complaint);
        merk = findViewById(R.id.et_merk_complaint);
        spesifikasi = findViewById(R.id.et_spesifikasi_complaint);
        jumlah = findViewById(R.id.et_jumlah_complaint);
        link = findViewById(R.id.et_link_image_complaint);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_complaint);
        btn_period = findViewById(R.id.btn_period_date_complaint);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_complaint);
        backasset = findViewById(R.id.backinAsset_complaint);
        btn_simpan = findViewById(R.id.btn_simpan_complaint);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_SDM");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetSDMActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backasset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AssetDataSDMActivity.class);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetSDMActivity.this, AssetDataSDMActivity.class));
