...
public class AddReceiverHumas extends AppCompatActivity {
    ...
    private static final String TAG = "AddReceiverHumas";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_penerimaan_humas);

        nameReceiver = findViewById(R.id.et_name_penerimaan_humas);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_humas);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_humas);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_humas);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_humas);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_humas);


        btn_save = findViewById(R.id.btn_simpan_penerimaan_humas);
        backcom = findViewById(R.id.back_penerimaan_humas);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_humas");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverHumas.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverHumas.this, ReceiverHumasActivity.class));
