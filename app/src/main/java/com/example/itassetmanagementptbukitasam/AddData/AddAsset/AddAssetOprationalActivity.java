...
public class AddAssetOprationalActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetOprationalActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_oprational);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_oprational);
        nama_aset = findViewById(R.id.et_nama_aset_oprational);
        supply = findViewById(R.id.et_Supply_oprational);
        datePurchase = findViewById(R.id.et_datePurchase_oprational);
        period = findViewById(R.id.et_datePeriod_oprational);
        nextperiod = findViewById(R.id.et_dateEndPeriod_oprational);
        jenis = findViewById(R.id.et_jenis_oprational);
        merk = findViewById(R.id.et_merk_oprational);
        spesifikasi = findViewById(R.id.et_spesifikasi_oprational);
        jumlah = findViewById(R.id.et_jumlah_oprational);
        link = findViewById(R.id.et_link_image_oprational);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_oprational);
        btn_period = findViewById(R.id.btn_period_date_oprational);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_oprational);
        backasset = findViewById(R.id.backinAsset_oprational);
        btn_simpan = findViewById(R.id.btn_simpan_oprational);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_Oprational");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetOprationalActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backasset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AssetOprationalActivity.class);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetOprationalActivity.this, AssetOprationalActivity.class));
