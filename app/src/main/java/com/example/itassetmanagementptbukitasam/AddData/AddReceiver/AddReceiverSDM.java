...
public class AddReceiverSDM extends AppCompatActivity {
    ...
    private static final String TAG = "AddReceiverSDM";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_penerimaan_sdm);

        nameReceiver = findViewById(R.id.et_name_penerimaan_sdm);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_sdm);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_sdm);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_sdm);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_sdm);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_sdm);


        btn_save = findViewById(R.id.btn_simpan_penerimaan_sdm);
        backcom = findViewById(R.id.back_penerimaan_sdm);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_sdm");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverSDM.this, ReceiverSDMActivity.class));
