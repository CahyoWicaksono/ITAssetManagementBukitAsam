...
public class AddResponseSafety extends AppCompatActivity {
    ...
    private static final String TAG = "AddResponseSafety";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_response_safety);

        nameResponse = findViewById(R.id.et_name_response_safety);
        dateResponse = findViewById(R.id.et_date_response_safety);
        divisionResponse = findViewById(R.id.et_division_response_safety);
        assetResponse = findViewById(R.id.et_name_asset_response_safety);
        radioGroupStatusResponse = findViewById(R.id.radio_group_response_safety);

        btn_save = findViewById(R.id.btn_submit_response_safety);
        backcom = findViewById(R.id.back_response_safety);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Response_Safety");
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddResponseSafety.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddResponseSafety.this, ResponsesSafetyActivity.class));
