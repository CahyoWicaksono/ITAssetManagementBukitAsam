...
public class AddReceiverOprational extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_penerimaan_oprational);

        nameReceiver = findViewById(R.id.et_name_penerimaan_oprational);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_oprational);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_oprational);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_oprational);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_oprational);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_oprational);


        btn_save = findViewById(R.id.btn_simpan_penerimaan_oprational);
        backcom = findViewById(R.id.back_penerimaan_oprational);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_oprational");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverOprational.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverOprational.this, ReceiverOprationalActivity.class));
