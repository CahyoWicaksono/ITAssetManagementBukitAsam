...
public class AddResponseLab extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_response_lab);

        nameResponse = findViewById(R.id.et_name_response_lab);
        dateResponse = findViewById(R.id.et_date_response_lab);
        divisionResponse = findViewById(R.id.et_division_response_lab);
        assetResponse = findViewById(R.id.et_name_asset_response_lab);
        radioGroupStatusResponse = findViewById(R.id.radio_group_response_lab);

        btn_save = findViewById(R.id.btn_submit_response_lab);
        backcom = findViewById(R.id.back_response_lab);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Response_Lab");
        ...
        dateResponse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddResponseLab.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddResponseLab.this, ResponseLabActivity.class));
