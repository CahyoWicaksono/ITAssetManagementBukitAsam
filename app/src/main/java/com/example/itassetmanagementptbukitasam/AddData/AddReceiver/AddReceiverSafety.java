...
public class AddReceiverSafety extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_penerimaan_safety);

        nameReceiver = findViewById(R.id.et_name_penerimaan_safety);
        dateReceiver = findViewById(R.id.et_kode_aset_penerimaan_safety);
        divisiReceiver = findViewById(R.id.et_divisi_penerimaan_safety);
        jumlahReceiver = findViewById(R.id.et_amount_penerimaan_safety);
        ConditionReceiver = findViewById(R.id.et_desc_penerimaan_safety);
        kodeassetReceiver = findViewById(R.id.et_kode_aset_penerimaan_safety);

        btn_save = findViewById(R.id.btn_simpan_penerimaan_safety);
        backcom = findViewById(R.id.back_penerimaan_safety);


        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Receiver_safety");
        ...
        dateReceiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddReceiverSafety.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddReceiverSafety.this, ReceiverSafetyActivity.class));
