...
public class AddAssetLogisticActivity extends AppCompatActivity {
    ...
    String assetID;
    private static final String TAG = "AddAssetLogisticActivity";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_asset_logistic);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset_logistic);
        nama_aset = findViewById(R.id.et_nama_aset_logistic);
        supply = findViewById(R.id.et_Supply_logistic);
        datePurchase = findViewById(R.id.et_datePurchase_logistic);
        period = findViewById(R.id.et_datePeriod_logistic);
        nextperiod = findViewById(R.id.et_dateEndPeriod_logistic);
        jenis = findViewById(R.id.et_jenis_logistic);
        merk = findViewById(R.id.et_merk_logistic);
        spesifikasi = findViewById(R.id.et_spesifikasi_logistic);
        jumlah = findViewById(R.id.et_jumlah_logistic);
        link = findViewById(R.id.et_link_image_logistic);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date_logistic);
        btn_period = findViewById(R.id.btn_period_date_logistic);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date_logistic);
        backasset = findViewById(R.id.backin_logistic);
        btn_simpan = findViewById(R.id.btn_simpan_logistic);

        firebaseAuth = FirebaseAuth.getInstance();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = database.getReference("Asset_Logistic");
        ...
        btn_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAssetLogisticActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetLogisticActivity.this, AssetDataLogisticActivity.class));
