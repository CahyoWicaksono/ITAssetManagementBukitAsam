...
public class AddAssetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.input_asset);


        //EditText
        kode_aset = findViewById(R.id.et_kode_aset);
        nama_aset = findViewById(R.id.et_nama_aset);
        supply = findViewById(R.id.et_Supply);
        datePurchase = findViewById(R.id.et_datePurchase);
        period = findViewById(R.id.et_datePeriod);
        nextperiod = findViewById(R.id.et_dateEndPeriod);
        jenis = findViewById(R.id.et_jenis);
        merk = findViewById(R.id.et_merk);
        spesifikasi = findViewById(R.id.et_spesifikasi);
        jumlah = findViewById(R.id.et_jumlah);
        link = findViewById(R.id.et_link_image);

        //Button
        btn_purchase = findViewById(R.id.btn_purchase_date);
        btn_period = findViewById(R.id.btn_period_date);
        btn_EndPeriod = findViewById(R.id.btn_end_period_date);
        backasset = findViewById(R.id.backinAsset);
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddAssetActivity.this, AssetDataActivity.class));
