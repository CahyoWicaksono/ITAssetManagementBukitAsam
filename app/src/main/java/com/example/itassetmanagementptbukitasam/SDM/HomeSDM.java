...
import com.example.itassetmanagementptbukitasam.ListData.Receiver.ListReceiver.ReceiverSDMActivity;
import com.example.itassetmanagementptbukitasam.ListData.Receiver.ListReceiver.ReceiverSafetyActivity;
...
import com.example.itassetmanagementptbukitasam.ListData.Response.List.ResponseViewSDMActivity;
import com.example.itassetmanagementptbukitasam.ListData.Response.List.ResponsesViewSafetyActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalSDMActivity;
import com.example.itassetmanagementptbukitasam.ListData.Withdrawal.List.ViewWithdrawalSafetyActivity;
...
import com.example.itassetmanagementptbukitasam.Safety.AddComplaintsafety;
import com.example.itassetmanagementptbukitasam.Safety.DeleteAcountSafety;
...
import com.example.itassetmanagementptbukitasam.Safety.UpdateProfileK3LActivity;
...
public class HomeSDM extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_sdm);

        swipeToRefresh();
        onBackPressed();

        menuComplain = findViewById(R.id.complaint_sdm);
        menuWith = findViewById(R.id.withdrawal_sdm);
        menuRequest = findViewById(R.id.request_sdm);
        menuReceiver = findViewById(R.id.receiver_sdm);
        menuResposnse = findViewById(R.id.response_sdm);

        database = findViewById(R.id.database_progress_sdm);
        qrprogress = findViewById(R.id.qr_progress_sdm);
        schedule = findViewById(R.id.schedule_progress_sdm);
        damageProgress = findViewById(R.id.damage_progress_sdm);
        information = findViewById(R.id.information_asset_sdm);

        location_admin = findViewById(R.id.location_sdm);
        slider_admin = findViewById(R.id.Slidder_sdm);

        auth = FirebaseAuth.getInstance();

        setting=findViewById(R.id.setting_sdm);
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SettingSDMActivity.class);
                startActivity(intent);
                finish();
            }
        });

        bottomNavigationView = findViewById(R.id.botomNavigationView_sdm);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(HomeSDM.this);
        ...
        information.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(HomeSDM.this)
                        .setTitle("Features")
        ...
        menuComplain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddComplaintSDM.class);
                startActivity(intent);
                finish();
            }
        });
        menuWith.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ViewWithdrawalSDMActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuResposnse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ResponseViewSDMActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RequestSDMActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuReceiver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ReceiverSDMActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)) {
            ...
            Toast.makeText(HomeSDM.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
