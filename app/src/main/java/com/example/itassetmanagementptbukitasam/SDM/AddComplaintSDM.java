...
public class AddComplaintSDM extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String ComplaintID;
    private static final String TAG = "AddComplaintSDM";


    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.input_complain_sdm);


        namaPengadu = findViewById(R.id.et_name_complaint_sdm);
        tanggalPengadu = findViewById(R.id.et_date_complaint_sdm);
        Divisi = findViewById(R.id.et_division_complaint_sdm);
        NamaAset = findViewById(R.id.et_name_asset_complaint_sdm);
        Problem = findViewById(R.id.et_problem_complaint_sdm);


        backmaintenance = findViewById(R.id.back_complaint_sdm);

        btn_simpan = findViewById(R.id.btn_submit_sdm);
        ...
        tanggalPengadu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddComplaintSDM.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if (valid) {
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            startActivity(new Intent(AddComplaintSDM.this, HomeSDM.class));
