...
public class DeleteAcountComplaint extends AppCompatActivity {
    ...
    private static final String TAG = "DeleteAcountComplaint";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delete_account_complaint);


        progressBar = findViewById(R.id.progressBar);
        editTextUserPwd = findViewById(R.id.editText_delete_user_pwd_sdm);
        textViewAutenticate = findViewById(R.id.textView_delete_user_authenticated);
        buttonDeleteUser = findViewById(R.id.button_delete_user_sdm);
        buttonReAutenticate = findViewById(R.id.button_delete_admin_authenticate_sdm);

        backDel = findViewById(R.id.back_delete_account_admin_sdm);
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(DeleteAcountComplaint.this, "Something went wrong !" +
                    "User details are not available at the moment", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(DeleteAcountComplaint.this, ProfileSDMActivity.class);
        ...
        backDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DeleteAcountComplaint.this, HomeSDM.class);
                startActivity(intent);
                finish();
    ...
    private void reAutenticated(FirebaseUser firebaseUser) {
        Button verifyUser = findViewById(R.id.button_delete_admin_authenticate_sdm);
        verifyUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userPwd)){
                    Toast.makeText(DeleteAcountComplaint.this, "Password is needed to continue", Toast.LENGTH_SHORT).show();
                    ...
                    firebaseUser.reauthenticate(authCredential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(DeleteAcountComplaint.this, "Password has been verified" +
                                ...
                                buttonDeleteUser.setBackgroundTintList(ContextCompat.getColorStateList(DeleteAcountComplaint.this,
                                        R.color.red));
                                ...
                                try {
                                    ...
                                    Toast.makeText(DeleteAcountComplaint.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
    ...
    private void showAlertDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DeleteAcountComplaint.this);
        ...
        firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    deleteUserData();
                    auth.signOut();
                    Toast.makeText(DeleteAcountComplaint.this, "User has been deleted!!",
                            Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(DeleteAcountComplaint.this, SignInComplaintActivity.class);
                    startActivity(intent);
                    finish();
                }else {
                    try {
