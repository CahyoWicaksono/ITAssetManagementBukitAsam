...
public class ProfileSDMActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textViewFullName    = findViewById(R.id.textView_show_full_name_complaint);
        textViewEmail       = findViewById(R.id.textView_show_email_complaint);
        textViewDob         = findViewById(R.id.textView_show_dob_complaint);
        textViewMobile      = findViewById(R.id.textView_show_mobile_complaint);
        textViewGender      = findViewById(R.id.textView_show_gender_complaint);
        progressBar         = findViewById(R.id.progress_bar_complaint);


        bottomNavigationViewProfile = findViewById(R.id.botomNavigationView_profile_complaint);
        ...
        if (firebaseUser == null){
            Toast.makeText(ProfileSDMActivity.this, "Something went wrong! User's details are not available at the moment",
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        databaseReference.child(UserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProfileSDMActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
