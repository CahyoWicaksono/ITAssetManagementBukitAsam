...
public class ViewWithAssetReport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_report_with_view);

        bottomNavigationView = findViewById(R.id.botomNavigation_with_report_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ViewWithAssetReport.this);
        ...
        recyclerView = findViewById(R.id.recyclerView_with_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(ViewWithAssetReport.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
