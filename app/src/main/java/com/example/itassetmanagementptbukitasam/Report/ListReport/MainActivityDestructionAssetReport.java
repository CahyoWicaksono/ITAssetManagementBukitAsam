...
public class MainActivityDestructionAssetReport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_report_exter);

        tambahLaporan = findViewById(R.id.tambah_report_Destruction);
        tambahLaporan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), UploadDiscructionReportActivity.class));
            }
        });
        bottomNavigationView = findViewById(R.id.botomNavigation_Destruction_report);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(MainActivityDestructionAssetReport.this);
        ...
        recyclerView = findViewById(R.id.recyclerView_Destruction);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(
                    MainActivityDestructionAssetReport.this);
            ...
            Toast.makeText(MainActivityDestructionAssetReport.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
