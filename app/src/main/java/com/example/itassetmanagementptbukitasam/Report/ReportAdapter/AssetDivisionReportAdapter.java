...
public class AssetDivisionReportAdapter extends FirebaseRecyclerAdapter<FileinModel, AssetDivisionReportAdapter.myviewholder> {

    public AssetDivisionReportAdapter(@NonNull FirebaseRecyclerOptions<FileinModel> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_item_asset_division,parent,false);
    ...
    public class myviewholder extends RecyclerView.ViewHolder{
        ...
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            text1 = itemView.findViewById(R.id.pdf_name_asset_logistic);
        }
    }
}
