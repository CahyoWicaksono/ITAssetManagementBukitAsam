...
import com.example.itassetmanagementptbukitasam.Report.AddReport.AssetReportActivity;
...
public class UploadAssetReportActivity extends AppCompatActivity {
    TextView edit;
    TextView uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_report_asset);

        edit = findViewById(R.id.editText_asset_report);
        uploadBTn = findViewById(R.id.btn_upload_asset);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Asset_Report");
    ...
    private void uploadPDF(Uri data) {
        ...
        final StorageReference reference = storageReference.child("Asset Report/"+ System.currentTimeMillis() + ".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadAssetReportActivity.this, "Report Submission Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void CreateReportAsset(View view) {
        // now here we will extract those pdf files
        startActivity(new Intent(UploadAssetReportActivity.this, AssetReportActivity.class));
    }
