...
public class AssetDamageReportAdapter extends FirebaseRecyclerAdapter<FileinModel, AssetDamageReportAdapter.myviewholder> {

    public AssetDamageReportAdapter(@NonNull FirebaseRecyclerOptions<FileinModel> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_item_damage,parent,false);
    ...
    public class myviewholder extends RecyclerView.ViewHolder{
        ...
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            text1 = itemView.findViewById(R.id.pdf_name_damage);
        }
    }
}
