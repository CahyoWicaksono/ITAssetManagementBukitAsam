...
public class MainActivityMaintenanceReport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_report_maintenance);

        tambahLaporan = findViewById(R.id.tambah_report_maintenance);
        tambahLaporan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), UploadMantenanceReportActivity.class));
            }
        });
        bottomNavigationView = findViewById(R.id.botomNavigation_report_maintenance);
        ...
        recyclerView = findViewById(R.id.recyclerView_maintenance);
