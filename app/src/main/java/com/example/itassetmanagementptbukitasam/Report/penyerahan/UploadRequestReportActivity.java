...
import com.example.itassetmanagementptbukitasam.Report.AddReport.RequestReportActivity;
...
public class UploadRequestReportActivity extends AppCompatActivity {
    TextView edit;
    TextView uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_report_request);

        edit = findViewById(R.id.editText_request_report);
        uploadBTn = findViewById(R.id.btn_upload_request);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Request_Report");
    ...
    private void uploadPDF(Uri data) {
        ...
        final StorageReference reference = storageReference.child("Request Report/"+ System.currentTimeMillis() + ".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadRequestReportActivity.this, "Request Submission Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void CreateRequestReport(View view) {
        // now here we will extract those pdf files
        startActivity(new Intent(UploadRequestReportActivity.this, RequestReportActivity.class));
    }
