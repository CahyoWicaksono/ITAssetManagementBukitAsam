...
public class UploadMantenanceReportActivity extends AppCompatActivity {
    TextView edit;
    TextView uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_report_maintenance);

        edit = findViewById(R.id.editText);
        uploadBTn = findViewById(R.id.btn);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Maintenance_Report");
    ...
    private void uploadPDF(Uri data) {
        ...
        final StorageReference reference = storageReference.child("Maintenance Report/"+ System.currentTimeMillis() + ".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadMantenanceReportActivity.this, "File Submission Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void  CreateReportMaintenance(View view) {
        // now here we will extract those pdf files
        startActivity(new Intent(UploadMantenanceReportActivity.this, MaintenanceReportActivity.class));
    }
