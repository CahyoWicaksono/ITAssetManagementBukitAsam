...
public class UploadDamageReportActivity extends AppCompatActivity {
    TextView edit;
    TextView uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_report_damage);

        edit = findViewById(R.id.editText_damage_report);
        uploadBTn = findViewById(R.id.btn_upload_damage);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Damage_Report");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadDamageReportActivity.this, "Report Submission Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void CreateReportDamage(View view) {
        // now here we will extract those pdf files
        startActivity(new Intent(UploadDamageReportActivity.this, DamageReportActivity.class));
    }
