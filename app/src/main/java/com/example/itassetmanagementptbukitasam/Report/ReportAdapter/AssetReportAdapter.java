...
public class AssetReportAdapter extends FirebaseRecyclerAdapter<FileinModel,AssetReportAdapter.myviewholder> {

    public AssetReportAdapter(@NonNull FirebaseRecyclerOptions<FileinModel> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_item_asset,parent,false);
    ...
    public class myviewholder extends RecyclerView.ViewHolder{
        ...
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            text1 = itemView.findViewById(R.id.pdf_name_asset);
        }
    }
}
