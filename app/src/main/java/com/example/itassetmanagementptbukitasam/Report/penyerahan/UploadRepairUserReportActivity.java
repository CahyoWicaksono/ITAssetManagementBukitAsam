...
public class UploadRepairUserReportActivity extends AppCompatActivity {
    TextView edit;
    TextView uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_report_repair_user);

        edit = findViewById(R.id.editText_repair_report_user);
        uploadBTn = findViewById(R.id.btn_upload_repair_report_user);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Repair_Report_user");
    ...
    private void uploadPDF(Uri data) {
        ...
        final StorageReference reference = storageReference.child("Repair Officer Report/"+ System.currentTimeMillis() + ".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadRepairUserReportActivity.this, "Report Submission Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void CreateRepairReportUser(View view) {
        // now here we will extract those pdf files
        startActivity(new Intent(UploadRepairUserReportActivity.this, RepairReportActivity.class));
    }
