...
public class ViewAssetReport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_report_asset_view);

        bottomNavigationView = findViewById(R.id.botomNavigation_report_asset_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(ViewAssetReport.this);
        ...
        recyclerView = findViewById(R.id.recyclerView_asset_view);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(ViewAssetReport.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
