...
public class ProfileUserActivity extends AppCompatActivity {
    private TextView textViewWelcome, textViewFullName, textViewEmail, textViewDob, textViewMobile, textViewGender;
    private ProgressBar progressBar;
    private String FullName,Email, Dob, Mobile,Gender;
    private FirebaseAuth auth;
    private SwipeRefreshLayout swipeRefreshLayout;
    private ImageView backProfile;
    private BottomNavigationView bottomNavigationViewProfUser;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bottomNavigationViewProfUser = findViewById(R.id.botomNavigationView_profile_user);

        bottomNavigationViewProfUser.setSelectedItemId(R.id.id_profile);

        bottomNavigationViewProfUser.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
        ...
        if (firebaseUser == null){
            Toast.makeText(ProfileUserActivity.this, "Something went wrong! User's details are not available at the moment",
        ...
        databaseReference.child(UserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (writeUserDetailsModel != null){
                    ...
                    Dob      = writeUserDetailsModel.Dob;
                    Gender   = writeUserDetailsModel.gender;
                    Mobile   = writeUserDetailsModel.mobile;
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProfileUserActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
