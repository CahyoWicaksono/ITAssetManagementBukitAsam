...
import com.example.itassetmanagementptbukitasam.Oprational.AddComplaintOprational;
...
public class HomeSafety extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_k3l);

        swipeToRefresh();
        onBackPressed();

        menuComplain = findViewById(R.id.complaint_safety);
        menuWith = findViewById(R.id.withdrawal_safety);
        menuRequest = findViewById(R.id.request_safety);
        menuReceiver = findViewById(R.id.receiver_safety);
        menuResposnse = findViewById(R.id.response_safety);

        database = findViewById(R.id.database_progress_safety);
        qrprogress = findViewById(R.id.qr_progress_safety);
        schedule = findViewById(R.id.schedule_progress_safety);
        damageProgress = findViewById(R.id.damage_progress_safety);
        information = findViewById(R.id.information_asset_safety);

        location_admin = findViewById(R.id.location_safety);
        slider_admin = findViewById(R.id.Slidder_safety);

        auth = FirebaseAuth.getInstance();

        setting=findViewById(R.id.setting_safety);
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SettingSafetyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        bottomNavigationView = findViewById(R.id.botomNavigationView_safety);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_profile:
                        ...
                        return true;
                    case R.id.id_code:
                        IntentIntegrator intentIntegrator = new IntentIntegrator(HomeSafety.this);
        ...
        information.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(HomeSafety.this)
                        .setTitle("Features")
        ...
        menuComplain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddComplaintsafety.class);
                startActivity(intent);
                finish();
            }
        });
        menuWith.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ViewWithdrawalSafetyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuResposnse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ResponsesViewSafetyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RequestSafetyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        menuReceiver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ReceiverSafetyActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ((intentResult.getContents() != null)){
            ...
            Toast.makeText(HomeSafety.this, "Scan Failed", Toast.LENGTH_SHORT).show();
        }
