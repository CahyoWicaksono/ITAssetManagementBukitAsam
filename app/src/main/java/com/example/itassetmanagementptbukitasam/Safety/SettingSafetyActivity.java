...
public class SettingSafetyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setting_app_safety);

        updateprofile = findViewById(R.id.updateprofile_safety);
        updateemail = findViewById(R.id.change_account_safety);
        updatepassword = findViewById(R.id.change_password_safety);
        deleteAccount = findViewById(R.id.delete_account_safety);
        logOut = findViewById(R.id.log_out_safety);

        back = findViewById(R.id.back_account_safety);
        ...
        updateprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), UpdateProfileK3LActivity.class);
        ...
        deleteAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), DeleteAcountSafety.class);
                startActivity(intent);
                finish();
            }
        });
        logOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                auth.signOut();
                Intent intent = new Intent(getApplicationContext(), SignInSafetyActivity.class);
                startActivity(intent);
            }
        });
