...
public class UpdateProfileK3LActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profile_k3l);

        editTextUpdateName = findViewById(R.id.editText_update_profile_name_safety);
        editTextUpdateDob = findViewById(R.id.editText_update_profile_dob_safety);
        editTextUpdateMobile = findViewById(R.id.editText_update_profile_mobile_safety);

        progressBar = findViewById(R.id.progressBar_safety);

        radioGroupUdateGender = findViewById(R.id.radio_group_update_profile_safety);
        date_picker = findViewById(R.id.imageView_date_picker_safety);

        backup = findViewById(R.id.backprofile_safety);
        ...
        backup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(UpdateProfileK3LActivity.this, ProfileK3LActivity.class);
        ...
        date_picker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pickerDialog = new DatePickerDialog(UpdateProfileK3LActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        updateProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateProfileSafety(firebaseUser);
            }
        });

    }

    private void updateProfileSafety(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(textFullname)) {
            Toast.makeText(UpdateProfileK3LActivity.this, "Please enter your fullname", Toast.LENGTH_SHORT).show();
            editTextUpdateName.setError("your fullname is required");
            editTextUpdateName.requestFocus();
        }else if (TextUtils.isEmpty(textDob)) {
            Toast.makeText(UpdateProfileK3LActivity.this, "Please enter your Date of Birth", Toast.LENGTH_SHORT).show();
            editTextUpdateDob.setError("Date of Birth is required");
            editTextUpdateDob.requestFocus();
        }else if (TextUtils.isEmpty(radioButtonUpdateSelect.getText())) {
            Toast.makeText(UpdateProfileK3LActivity.this, "Please enter your gender", Toast.LENGTH_SHORT).show();
            radioButtonUpdateSelect.setError("Gender is required");
            radioButtonUpdateSelect.requestFocus();
        }else if (TextUtils.isEmpty(textMobile)) {
            Toast.makeText(UpdateProfileK3LActivity.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
            ...
            String SafetyId = firebaseUser.getUid();

            progressBar.setVisibility(View.VISIBLE);

            databaseReference.child(SafetyId).setValue(writeAccountDetailsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(UpdateProfileK3LActivity.this, "Update Successfull", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(UpdateProfileK3LActivity.this, ProfileK3LActivity.class);
                        ...
                        try {
                            ...
                            Toast.makeText(UpdateProfileK3LActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        databaseReference.child(userIdOfRegistered).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (writeAccountDetailsModel != null) {
                    ...
                    Toast.makeText(UpdateProfileK3LActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
                progressBar.setVisibility(View.GONE);
            }
